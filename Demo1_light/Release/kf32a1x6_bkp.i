...
# 31 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_bkp.h" 2
...
# 36 "../src/kf32a1x6_bkp.c" 2
# 46 "../src/kf32a1x6_bkp.c"
void BKP_Reset (void)
{
...
RetStatus BKP_Clear_Pin_TAMP_INT_Flag (uint32_t PinSel)
{
 ...
 uint32_t wait_flag=0x0000;
    ...
    (((BKP_SFRmap *) ((uint32_t)0x40001400))->INT) |= tmpreg;
    while((((((BKP_SFRmap *) ((uint32_t)0x40001400))->INT) & tmpreg1)>>((16)+PinSel))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
    (((BKP_SFRmap *) ((uint32_t)0x40001400))->INT) &= ~tmpreg;
