...
# 1 "<command-line>"
# 1 "../src/kf32a1x6_op.c"
# 31 "../src/kf32a1x6_op.c"
# 1 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_op.h" 1
# 29 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_op.h"
...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_op.h" 2
...
# 34 "../src/kf32a1x6_op.c" 2
# 45 "../src/kf32a1x6_op.c"
void OP_Reset(void)
{
 RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((20))), TRUE);
 RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((20))), FALSE);
 PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((20))), TRUE);
}
...
void OP_Enable(uint32_t OPx_NUM, FunctionalState NewState)
{
 ...
 (((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL0) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL0), ~(1 << OPx_NUM), NewState << OPx_NUM);
}
...
void OP_OUTPUT_Enable(uint32_t OPx_NUM, FunctionalState NewState)
{
 ...
 tmpreg = NewState << ((4) + OPx_NUM);
 tmask = 1 << ((4) + OPx_NUM);
 (((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL0) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL0), ~tmask, tmpreg);
}
# 96 "../src/kf32a1x6_op.c"
   ...
   uint32_t GAIN_Value, FunctionalState NewState)
{
 ...
 tmpreg = NewState << ((8) + OPx_NUM*6 + GAIN_Value);
 tmask = 1 << ((8) + OPx_NUM*6 + GAIN_Value);
 (((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL0) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL0), ~tmask, tmpreg);
}
...
void OP_OPUPUT_Parallel_Resistance(uint32_t OPx_NUM, FunctionalState NewState)
{
 ...
 tmpreg = NewState << ((28) + OPx_NUM);
 tmask = 1 << ((28) + OPx_NUM);
 (((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL1) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL1), ~tmask, tmpreg);
}
# 139 "../src/kf32a1x6_op.c"
void OP_Positive_INPUT_Selsect(uint32_t OPx_NUM_OUTPUT,uint32_t OPx_NUM_PINPUT, FunctionalState NewState)
{
 uint32_t tmpreg;
 uint32_t tmask;
 ...
 tmpreg = NewState << ((16) + OPx_NUM_OUTPUT*3 + OPx_NUM_PINPUT);
 tmask = 1 << ((16) + OPx_NUM_OUTPUT*3 + OPx_NUM_PINPUT);
 (((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL1) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL1), ~tmask, tmpreg);
}
...
void OP_VCOM_Positive_Select(uint32_t Select)
{
 ...
 (((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL1) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL1), ~((uint32_t)0x03<<((3))), Select << (3));
}
...
void OP_VCOM_Buffer_Output_Enable(FunctionalState NewState)
{
 ...
 (((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL1) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL1), ~((uint32_t)1<<((2))), NewState << (2));
}
...
void OP_VCOM_Buffer_Enable(FunctionalState NewState)
{
 ...
 (((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL1) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL1), ~((uint32_t)1<<((1))), NewState << (1));
}
...
void CMP3_Enable(FunctionalState NewState)
{
 ...
 (((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL1) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->CTL1), ~((uint32_t)1<<((0))), NewState);
}
# 240 "../src/kf32a1x6_op.c"
void OP_TRIM_PMOS_Enable(FunctionalState NewState)
{

 ((void)0);

 (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM0) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM0), ~((uint32_t)1<<((30))), NewState << (30));
}
...
void OP_TRIM_NMOS_Enable(FunctionalState NewState)
{
 ...
 (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM0) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM0), ~((uint32_t)1<<((31))), NewState << (31));
}
...
OP_TRIM_OUT_Flag(uint32_t OPx_NUM)
{
 ...
 {
 case ((uint32_t)0):
  Value = (((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM0) & ((uint32_t)1<<((24)))) >> (24));
  break;
 case ((uint32_t)1):
  Value = (((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM1) & ((uint32_t)1<<((24)))) >> (24));
  break;
 case ((uint32_t)2):
  Value = (((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM2) & ((uint32_t)1<<((24)))) >> (24));
  break;
 case ((uint32_t)3):
  Value = (((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM3) & ((uint32_t)1<<((24)))) >> (24));
  break;
 default:break;
 }
 return Value;
...
void OP_TRIM_PMOS_Value_Config(uint32_t OPx_NUM, uint8_t Value)
{
 ...
 {
 case ((uint32_t)0):
  (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM0) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM0), ~((uint32_t)0x3F<<((8))), tmpreg);
  break;
 case ((uint32_t)1):
  (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM1) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM1), ~((uint32_t)0x3F<<((8))), tmpreg);
  break;
 case ((uint32_t)2):
  (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM2) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM2), ~((uint32_t)0x3F<<((8))), tmpreg);
  break;
 case ((uint32_t)3):
  (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM3) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM3), ~((uint32_t)0x3F<<((8))), tmpreg);
  break;
 default:break;
 }
}
...
void OP_TRIM_PMOS_Direction_Select(uint32_t OPx_NUM, uint32_t Direction)
{
 ...
 {
 case ((uint32_t)0):
  (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM0) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM0), ~((uint32_t)1<<((7))), tmpreg);
  break;
 case ((uint32_t)1):
  (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM1) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM1), ~((uint32_t)1<<((7))), tmpreg);
  break;
 case ((uint32_t)2):
  (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM2) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM2), ~((uint32_t)1<<((7))), tmpreg);
  break;
 case ((uint32_t)3):
  (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM3) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM3), ~((uint32_t)1<<((7))), tmpreg);
  break;
 default:break;
 }
}
...
void OP_TRIM_NMOS_Value_Config(uint32_t OPx_NUM, uint8_t Value)
{
 ...
 {
 case ((uint32_t)0):
  (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM0) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM0), ~((uint32_t)0x3F<<((1))), tmpreg);
  break;
 case ((uint32_t)1):
  (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM1) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM1), ~((uint32_t)0x3F<<((1))), tmpreg);
  break;
 case ((uint32_t)2):
  (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM2) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM2), ~((uint32_t)0x3F<<((1))), tmpreg);
  break;
 case ((uint32_t)3):
  (((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM3) = SFR_Config((((OP_SFRmap *) ((uint32_t)0x40002A00))->TRIM3), ~((uint32_t)0x3F<<((1))), tmpreg);
  break;
 default:break;
 }
}
