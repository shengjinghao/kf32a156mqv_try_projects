# 1 "../src/kf32a1x6_canfd.c"
# 1 "D:\\KungFu32\\workspace32\\Demo1_light\\Release//"
# 1 "<command-line>"
# 1 "../src/kf32a1x6_canfd.c"
# 33 "../src/kf32a1x6_canfd.c"
...
# 29 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_canfd_156.h"
...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_canfd_156.h" 2
...
static void Can_m_FdClearAllFlag(const uint8_t Can_Controller_Index)
{
 ...
 if (ControllerRegPtr->CANFD_IFR.B.BEIF == 0x01)
 {
  ...
  while ((ControllerRegPtr->CANFD_IFR.B.BEIF == (1U)) &&(delay_time--))
   ;
 ...
 if (ControllerRegPtr->CANFD_IFR.B.BOFFIF == 0x01)
 {
  ...
  while ((ControllerRegPtr->CANFD_IFR.B.BOFFIF == (1U)) &&(delay_time--))
   ;
 ...
 if (ControllerRegPtr->CANFD_IFR.B.EAIF == 0x01)
 {
  ...
  while ((ControllerRegPtr->CANFD_IFR.B.EAIF == (1U)) &&(delay_time--))
   ;
 ...
 if (ControllerRegPtr->CANFD_IFR.B.ENIF == 0x01)
 {
  ...
  Rcr_Value = ControllerRegPtr->CANFD_RCR.R;
  while ((ControllerRegPtr->CANFD_IFR.B.ENIF == (1U)) &&(delay_time--))
   ;
 ...
 if (ControllerRegPtr->CANFD_IFR.B.DOVFIF == 0x01)
 {
  ...
  while ((ControllerRegPtr->CANFD_IFR.B.DOVFIF == (1U)) &&(delay_time--))
   ;
 ...
 if (ControllerRegPtr->CANFD_IFR.B.TDCFAILIF == 0x01)
 {
  ...
  while ((ControllerRegPtr->CANFD_IFR.B.TDCFAILIF == (1U)) &&(delay_time--))
   ;
 ...
 if (ControllerRegPtr->CANFD_IFR.B.CANTXIF == 0x01)
 {
  ...
  while ((ControllerRegPtr->CANFD_IFR.B.CANTXIF == (1U)) &&(delay_time--))
   ;
 ...
 if (ControllerRegPtr->CANFD_IFR.B.CANRXIF == 0x01)
 {
  ...
  while ((ControllerRegPtr->CANFD_IFR.B.CANRXIF == (1U)) &&(delay_time--))
   ;
 ...
 if (ControllerRegPtr->CANFD_IFR.B.WUIF == 0x01)
 {
  ...
  while ((ControllerRegPtr->CANFD_IFR.B.WUIF == (1U)) &&(delay_time--))
   ;
...
static void Can_m_FdIntSet(const uint8_t Can_Controller_Index, const Can_ControllerConfigType *Can_ControllerConfig, const uint8_t IntIndex)
{
 ...
 ControllerRegPtr->CANFD_IER.B.ALIE = (1U);
 ...
 ControllerRegPtr->CANFD_IER.B.RXBSTAIE = (0U);

 ControllerRegPtr->CANFD_IER.B.TDCFAILIE = (0U);

 ControllerRegPtr->CANFD_IER.B.ARBFAILIE = (0U);

 ControllerRegPtr->CANFD_IER.B.MOENDIE = (0U);


 (*((volatile struct Kf32a_Int_Reg *)0x40200000)).CTL0.B.PRIGROUP = 0x00;


 if (Can_Controller_Index == 0)
 {
  (*((volatile struct Kf32a_Int_Reg *)0x40200000)).EIE1.B.CAN4IE = 0x01;

  (*((volatile struct Kf32a_Int_Reg *)0x40200000)).IP7.B.PRI32P = Can_ControllerConfig[IntIndex].Can_Controller_InterruptConfig->PreemptionPriority;

  (*((volatile struct Kf32a_Int_Reg *)0x40200000)).IP7.B.PRI32S = Can_ControllerConfig[IntIndex].Can_Controller_InterruptConfig->SubPriority;
 }
 else if (Can_Controller_Index == 1)
 {
  (*((volatile struct Kf32a_Int_Reg *)0x40200000)).EIE2.B.CANFD6IE = 0x01;

  (*((volatile struct Kf32a_Int_Reg *)0x40200000)).IP11.B.PRI50P = Can_ControllerConfig[IntIndex].Can_Controller_InterruptConfig->PreemptionPriority;

  (*((volatile struct Kf32a_Int_Reg *)0x40200000)).IP11.B.PRI50S = Can_ControllerConfig[IntIndex].Can_Controller_InterruptConfig->SubPriority;
 }
 else if (Can_Controller_Index == 2)
 {
  (*((volatile struct Kf32a_Int_Reg *)0x40200000)).EIE2.B.CANFD7IE = 0x01;

  (*((volatile struct Kf32a_Int_Reg *)0x40200000)).IP11.B.PRI51P = Can_ControllerConfig[IntIndex].Can_Controller_InterruptConfig->PreemptionPriority;

  (*((volatile struct Kf32a_Int_Reg *)0x40200000)).IP11.B.PRI51S = Can_ControllerConfig[IntIndex].Can_Controller_InterruptConfig->SubPriority;
 }
 else
 {
 }

 (*((volatile struct Kf32a_Int_Reg *)0x40200000)).CTL0.B.AIE = (1U);
}
...
static void Can_m_FdFilterInit(const uint8_t Can_Controller_Index, const Can_ControllerConfigType *Can_ControllerConfig, const uint8_t IntIndex)
{
 ...
 ControllerRegPtr->CANFD_CTLR1.B.MBMSKEN = (1U);

 if (ControllerRegPtr->CANFD_CTLR0.B.MBSIZE == CAN_8_BYTE_DATALENGTH)
 {
  for (uint8_t mailbox_count = 0; mailbox_count < (51U); mailbox_count++)
  {
 ...
 {
  for (uint8_t mailbox_count = 0; mailbox_count < (36U); mailbox_count++)
  {
   if (Can_ControllerConfig[IntIndex].Can_HwFilter[0].Can_IdFilterFrame[mailbox_count] == CAN_FILTER_STANDARD)
   {
    *(((uint32_t *)Can_m_ControllersInfo[Can_Controller_Index].FilterBaseAddress) - mailbox_count) = ((Can_ControllerConfig[IntIndex].Can_HwFilter[0].MaskCode[mailbox_count]) << 21);
 ...
 {
  for (uint8_t mailbox_count = 0; mailbox_count < (23U); mailbox_count++)
  {
   if (Can_ControllerConfig[IntIndex].Can_HwFilter[0].Can_IdFilterFrame[mailbox_count] == CAN_FILTER_STANDARD)
   {
    *(((uint32_t *)Can_m_ControllersInfo[Can_Controller_Index].FilterBaseAddress) - mailbox_count) = ((Can_ControllerConfig[IntIndex].Can_HwFilter[0].MaskCode[mailbox_count]) << 21);
 ...
 {
  for (uint8_t mailbox_count = 0; mailbox_count < (13U); mailbox_count++)
  {
   if (Can_ControllerConfig[IntIndex].Can_HwFilter[0].Can_IdFilterFrame[mailbox_count] == CAN_FILTER_STANDARD)
   {
    *(((uint32_t *)Can_m_ControllersInfo[Can_Controller_Index].FilterBaseAddress) - mailbox_count) = ((Can_ControllerConfig[IntIndex].Can_HwFilter[0].MaskCode[mailbox_count]) << 21);
...
static Can_ReturnType Can_m_FdCopyDataTo8MailBox(const uint8_t Can_Controller_Index, const Can_MailboxNumType Mailbox_Number, Canfd_MailboxHeaderType *Can_MailboxHeader)
{
 ...
 ret = Can_m_FdWaitConfilct(Can_Controller_Index,(0xF));
...
# 825 "../src/kf32a1x6_canfd.c"
Can_ReturnType Can_m_FdMailBox_Write(const uint8_t Can_Controller_Index, const Can_MailboxNumType Mailbox_Number, Canfd_MailboxHeaderType *Can_MailboxHeader)
{
 Can_ReturnType ret = CAN_UNINITIALIZED;
 Can_ReturnType (*func)(const uint8_t Can_Controller_Index, const Can_MailboxNumType Mailbox_Number, Canfd_MailboxHeaderType *Can_MailboxHeader) = ((void *)0U);
 volatile Kf32a_Canfd_Reg *ControllerRegPtr = (Kf32a_Canfd_Reg *)Can_m_ControllersInfo[Can_Controller_Index].BaseAddress;
...
{
 Can_ReturnType ret = CAN_UNINITIALIZED;
 Can_ReturnType (*func)(const uint8_t Can_Controller_Index, const Can_MailboxNumType Mailbox_Number, Canfd_MailboxHeaderType *Can_MailboxHeader, Can_MailBoxType Can_MailBox) = ((void *)0U);
 volatile Kf32a_Canfd_Reg *ControllerRegPtr = (Kf32a_Canfd_Reg *)Can_m_ControllersInfo[Can_Controller_Index].BaseAddress;
...
# 961 "../src/kf32a1x6_canfd.c"
Can_ReturnType Can_m_FdTransmitpack(const uint8_t Can_Controller_Index)
{
 Can_ReturnType ret = CAN_UNINITIALIZED;
 volatile uint32_t delay_count = (0xF);
...
# 1301 "../src/kf32a1x6_canfd.c"
ClearFlag_ReturnType Can_m_FdClearIntFlag(const uint8_t Can_Controller_Index, Can_Controller_InterruptFlagType *Can_Controller_InterruptFlag, uint8_t rmc_count)
{
 volatile Kf32a_Canfd_Reg *ControllerRegPtr = (Kf32a_Canfd_Reg *)Can_m_ControllersInfo[Can_Controller_Index].BaseAddress;
 ClearFlag_ReturnType ret = {0};
 volatile uint32_t delay_time = (0xF);
 volatile uint32_t Rcr_Value = 0;
...
Can_MailBoxType Can_m_FdGetMailBoxState(const uint8_t Can_Controller_Index, const Can_MailboxNumType Mailbox_Number)
{
 ...
 ((void)0);
 volatile Kf32a_Canfd_Reg *ControllerRegPtr = (Kf32a_Canfd_Reg *)Can_m_ControllersInfo[Can_Controller_Index].BaseAddress;
 ret = Can_m_FdWaitConfilct(Can_Controller_Index,(0x5));
 if (ret == CAN_OK || ret == CAN_RAM_TXSTA || ret == CAN_RAM_RXSTA)
 {
  if (ControllerRegPtr->CANFD_CTLR0.B.MBSIZE == CAN_8_BYTE_DATALENGTH)
  {
...
void Can_m_FdControllerDeInit(const uint8_t Can_Controller_Index)
{
 ...
 ((void)0);
 if (Can_m_ControllersInfo[Can_Controller_Index].BaseAddress == (0x40002E80U))
 {
  (*((volatile struct Kf32a_Mcu_Rst_Reg *)0x40001500)).CTL3.B.CANFD6RST = 0x01;
  (*((volatile struct Kf32a_Mcu_Pclk_Reg *)0x40002600)).CTL3.B.CANFD6CLKEN = 0x01;
  (*((volatile struct Kf32a_Mcu_Rst_Reg *)0x40001500)).CTL3.B.CANFD6RST = 0x00;
 }
 else if (Can_m_ControllersInfo[Can_Controller_Index].BaseAddress == (0x40002F00U))
 {
  (*((volatile struct Kf32a_Mcu_Rst_Reg *)0x40001500)).CTL3.B.CANFD7RST = 0x01;
  (*((volatile struct Kf32a_Mcu_Pclk_Reg *)0x40002600)).CTL3.B.CANFD7CLKEN = 0x01;
  (*((volatile struct Kf32a_Mcu_Rst_Reg *)0x40001500)).CTL3.B.CANFD7RST = 0x00;
 }
 else
 {
 }
}
# 1740 "../src/kf32a1x6_canfd.c"
void Can_m_FdControllerInit(const uint8_t Can_Controller_Index, const Can_ControllerConfigType *Can_ControllerConfig, const Can_InitIndexType InitIndex)
{
 volatile Kf32a_Canfd_Reg *ControllerRegPtr = (Kf32a_Canfd_Reg *)Can_m_ControllersInfo[Can_Controller_Index].BaseAddress;
 ...
 ControllerRegPtr->CANFD_CTLR0.B.CANEN = (0U);

 ControllerRegPtr->CANFD_CTLR0.B.RSMOD = (1U);

 while (delay_count--)
  ;

 ControllerRegPtr->CANFD_CTLR0.B.SILENT = (0U);

 ControllerRegPtr->CANFD_CTLR0.B.SLEEP = (0U);

 ((void)0);
 if (Can_ControllerConfig[InitIndex].CanfdMode == CANFD_LOOP_INTERNAL_MODE)
 {
  ControllerRegPtr->CANFD_CTLR0.B.LBACK = (1U);
  ControllerRegPtr->CANFD_CTLR1.B.LBSEL = (1U);
 }
 else if (Can_ControllerConfig[InitIndex].CanfdMode == CANFD_LOOP_EXTERNAL_MODE)
 {
  ControllerRegPtr->CANFD_CTLR0.B.LBACK = (1U);
  ControllerRegPtr->CANFD_CTLR1.B.LBSEL = (0U);
 }
 else if (Can_ControllerConfig[InitIndex].CanfdMode == CANFD_SILENT_MODE)
 {
  ControllerRegPtr->CANFD_CTLR0.B.LBACK = (0U);
  ControllerRegPtr->CANFD_CTLR0.B.SILENT = (1U);
 }
 ...
 ControllerRegPtr->CANFD_CTLR1.B.CKMODE = (1U);
# 1802 "../src/kf32a1x6_canfd.c"
 ...
 ControllerRegPtr->CANFD_CTLR0.B.CANEN = (1U);

 ControllerRegPtr->CANFD_CTLR0.B.RSMOD = (0U);
