 ...
 ******************************************************************************
 *  $File Name$       : kf32a1x6_systick.c                           	      *
 *  $Author$          : ChipON AE/FAE Group                                   *
 *  $Data$            : 2021-07-08                                            *
 *  $Hard Version     : kf32a1x6-MINI-EVB_V1.2                                *
 *  $Description$     : This file provides the beat timer peripheral 		  *
 *  					functions, including:								  *
 *          			+ The systolic peripheral initializes the function 	  *
 *          			  definition     									  *
 *          			+ The definition of the SYSTIK function configuration *
 *          			  function	  										  *
 ******************************************************************************
...
/*******************************************************************************
**                      (SYSTICK) Module private definition                   **
*******************************************************************************/
