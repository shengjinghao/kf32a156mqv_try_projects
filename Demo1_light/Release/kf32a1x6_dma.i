...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_dma.h" 2
...
# 36 "../src/kf32a1x6_dma.c" 2
# 64 "../src/kf32a1x6_dma.c"
void DMA_Reset (DMA_SFRmap* DMAx)
{
    ...
    else if (DMAx == ((DMA_SFRmap *) ((uint32_t)0x40001700)))
    {
