...
#ifndef KF32A156_CANFD_H_
#define KF32A156_CANFD_H_
#include "kf32a1x6.h"
#include "stdint.h"
...
#define STD_ON 					(1U)
#define STD_OFF 				(0U)
#define TRANSMIT_ENABEL_TIME    (0x3F)
#define MAIL_ARBITRATE_TIME     (0xF)
#define RAM_STATE_LOOP_TIME     (0x5)
#define RAM_CONFLICT_LOOP_TIME  (0xF)
#define CLEAR_FLAG_TIME         (0xF)
#define HARDWARE_RETRANSMIT     STD_ON
#define HARDWARE_FILTER         STD_ON
#define WORKSOURCE_HFCLK        STD_ON
#define CAN_BUSOFF_RECOVERY_INTERRUPT   STD_ON
