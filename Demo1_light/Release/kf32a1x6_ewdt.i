...
# 27 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_ewdt.h" 2
...
# 34 "../src/kf32a1x6_ewdt.c" 2
# 44 "../src/kf32a1x6_ewdt.c"
void EWDT_Reset (void)
{

    RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((27))), TRUE);
    RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((27))), FALSE);

    PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((27))), TRUE);
}
# 62 "../src/kf32a1x6_ewdt.c"
void EWDT_CLK_Select(uint32_t CLK)
{
 uint32_t tmpreg;
 ...
 tmpreg = CLK << (18);
 (((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) = SFR_Config((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL), ~((uint32_t)0x03<<((18))), tmpreg);
}
# 96 "../src/kf32a1x6_ewdt.c"
void EWDT_Clock_Div_Select(uint32_t CLK_DIV)
{
 ...
 tmpreg = CLK_DIV << (3);
 (((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) = SFR_Config((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL), ~((uint32_t)0x1F<<((3))), tmpreg);
}
...
void EWDT_Input_Effective_Single_Select(uint32_t Select)
{
 ...
 tmpreg = Select << (17);
 (((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) = SFR_Config((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL), ~((uint32_t)1<<((17))), tmpreg);
}
...
void EWDT_Input_Single_Enable(FunctionalState NewState)
{
 ...
 tmpreg = NewState << (16);
 (((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) = SFR_Config((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL), ~((uint32_t)1<<((16))), tmpreg);
}
...
void EWDT_Output_Effective_Single_Select(uint32_t Select)
{
 ...
 tmpreg = Select << (24);
 (((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) = SFR_Config((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL), ~((uint32_t)1<<((24))), tmpreg);
}
...
void EWDT_Threshold_Config(uint32_t Threshold)
{
 ...
 tmpreg = Threshold << (8);
 (((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) = SFR_Config((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL), ~((uint32_t)0x7F<<((8))), tmpreg);
}
...
void EWDT_Enable(FunctionalState NewState)
{
 ...
 (((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) = SFR_Config((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL), ~((uint32_t)1<<((0))), NewState);
}
...
{
 return ((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CNT) & ((uint32_t)0x7F<<((0))));
}
...
void EWDT_Set_Count_Value(uint8_t Value)
{
 ...
 (((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CNT) = SFR_Config((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CNT), ~((uint32_t)0x7F<<((0))), Value);
}
# 224 "../src/kf32a1x6_ewdt.c"
void EWDT_Reset_Single_INT_Enable(FunctionalState NewState)
{
 uint32_t tmpreg;
 ...
 tmpreg = NewState << (21);
 (((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) = SFR_Config((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL), ~((uint32_t)1<<((21))), tmpreg);
}
...
void EWDT_Count40_INT_Enable(FunctionalState NewState)
{
 ...
 tmpreg = NewState << (1);
 (((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) = SFR_Config((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL), ~((uint32_t)1<<((1))), tmpreg);
}
...
FlagStatus EWDT_Get_Reset_INT_Flag(void)
{
 return (((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) & ((uint32_t)1<<((23)))) >> (23));
}
...
FlagStatus EWDT_Get_Count40_INT_Flag(void)
{
 return (((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) & ((uint32_t)1<<((2)))) >> (2));
}
...
RetStatus EWDT_Clear_Reset_INT_Flag(void)
{
 ...
 __asm volatile("SET [%0], #%1"::"r"(&((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL))),"i"((22)));
 while(((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) & ((uint32_t)1<<((23))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
 __asm volatile("CLR [%0], #%1"::"r"(&((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL))),"i"((22)));
 if(wait_flag==(0xFFFF))
 {
  return FAILURE;
 }
...
{
 uint32_t wait_flag = 0x0000;
 __asm volatile("SET [%0], #%1"::"r"(&((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL))),"i"((15)));
 while(((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL) & ((uint32_t)1<<((2))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
 __asm volatile("CLR [%0], #%1"::"r"(&((((EWDT_SFRmap *) ((uint32_t)0x40002B00))->CTL))),"i"((15)));
 if(wait_flag==(0xFFFF))
 {
  return FAILURE;
 }
