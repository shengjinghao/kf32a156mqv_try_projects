 ...
 ******************************************************************************
 *  $File Name$       : KF32A1X6.h                              	            *
 *  $Author$          : ChipON AE/FAE Group                  		  		      *
 *  $Data$            : 2021-07-08                                            *
 *  $AutoSAR Version  : V2.0 	                                       	      *
 *  $Description$     : KF32A1X6 series peripheral access entry file, 		   *
 *  					including:											                  *
...
typedef struct GPIO_MenMap
{
	...
	volatile	   uint32_t RESERVED[3];   /* ƫ��0x28 */
	volatile	   uint32_t RMP_MSB;       /* GPIO��ӳ��˿�ģ��ѡ��Ĵ���, ƫ��:0x34 */
}GPIO_SFRmap;
...
{
	volatile uint32_t CTL;				/* PLL���ƼĴ�����ƫ�ƣ�0x00 */
}PLL_SFRmap;
...
typedef struct SYSCTL_MemMap {
    ...
    volatile	uint32_t MSPSPA;     /* ����ռ���ƼĴ���, ƫ��:0x1C */
    volatile	uint32_t PSPSPA;     /* ����ռ���ƼĴ���, ƫ��:0x20 */
}SYSCTL_SFRmap;
...
{
    volatile uint32_t CTL;            /* ϵͳ���Ķ�ʱ�����ƺ�״̬�Ĵ���, ƫ��:0xA0 */
    volatile uint32_t RELOAD;         /* ϵͳ���Ķ�ʱ������ֵ�Ĵ���, ƫ��:0xA4 */
    volatile uint32_t CV;             /* ϵͳ���Ķ�ʱ����ǰֵ�Ĵ���, ƫ��:0xA8 */
    volatile uint32_t CALI;           /* ϵͳ���Ķ�ʱ��У��Ĵ���, ƫ��:0xAC */
}SYSTICK_SFRmap;
...
typedef struct ATIM_MemMap
{
    ...
    volatile	   uint32_t TXCCTCTL;	    	/* �Ƚ������㶨ʱ�� Tx ���ƼĴ���, ƫ��:0x34 */
    volatile	   uint32_t TZCCTCTL;    		/* �Ƚ������㶨ʱ�� Tz ���ƼĴ���, ƫ��:0x38 */
    			   uint32_t RESERVED0;			/* ������ַ, ƫ��:0x3C */
    volatile	   uint32_t COMH1;    			/* ECCPͨ��1���Ͽ��ƼĴ���H, ƫ��:0x40 */
    volatile	   uint32_t COML1;    			/* ECCPͨ��1���Ͽ��ƼĴ���L, ƫ��:0x44 */
    volatile	   uint32_t FAUCTL1;    		/* Fault���ƼĴ���1, ƫ��:0x48 */
    volatile	   uint32_t DITCTL;    			/* �������ƼĴ���, ƫ��:0x4C */
    volatile	   uint32_t COMH2;    			/* ECCPͨ��2���Ͽ��ƼĴ���H, ƫ��:0x50 */
    volatile	   uint32_t COML2;    			/* ECCPͨ��2���Ͽ��ƼĴ���L, ƫ��:0x54 */
    volatile	   uint32_t FAUCTL2;    		/* Fault���ƼĴ���2, ƫ��:0x58 */
    volatile	   uint32_t CCRCTL;    			/* Tx/z����AD���ƼĴ���, ƫ��:0x5C */
    volatile	   uint32_t COMH3;    			/* ECCPͨ��3���Ͽ��ƼĴ���H, ƫ��:0x60 */
    volatile	   uint32_t COML3;    			/* ECCPͨ��3���Ͽ��ƼĴ���L, ƫ��:0x64 */
    volatile	   uint32_t FAUCTL3;    		/* Fault���ƼĴ���3, ƫ��:0x68 */
    			   uint32_t RESERVED1;			/* ������ַ, ƫ��:0x6C */
    volatile	   uint32_t COMH4;    			/* ECCPͨ��4���Ͽ��ƼĴ���H, ƫ��:0x70 */
    volatile	   uint32_t COML4;    			/* ECCPͨ��4���Ͽ��ƼĴ���L, ƫ��:0x74 */
    volatile	   uint32_t FAUCTL4;    		/* Fault���ƼĴ���4, ƫ��:0x78 */
...
{
	volatile       uint32_t CNT;				/*Tx_CNT�Ĵ�����ƫ��0x00*/
	volatile	   uint32_t	PHS;				/*Tx��λ�Ĵ�����ƫ��0x04*/
	volatile	   uint32_t	PPX;				/*Tx���ڼĴ�����ƫ��0x08*/
	volatile	   uint32_t	PRSC;				/*TxԤ��Ƶ���üĴ�����ƫ��0x0C*/
	volatile	   uint32_t	CTL;				/*Tx���ƼĴ�����ƫ��0x10*/
	volatile	   uint32_t	RA;					/*EPWMxռ�ձ�A�Ĵ�����ƫ��0x14*/
	volatile	   uint32_t	RB;					/*EPWMxռ�ձ�B�Ĵ�����ƫ��0x18*/
	volatile	   uint32_t	CTLA;				/*EPWMxA������ƼĴ�����ƫ��0x1C*/
	volatile	   uint32_t	CTLB;				/*EPWMxB������ƼĴ�����ƫ��0x20*/
	volatile	   uint32_t	DBCTL;				/*TEPWMx�������ƼĴ�����ƫ��0x24*/
	volatile	   uint32_t	DBT;				/*EPWMx����ʱ����ƼĴ�����ƫ��0x28*/
	volatile	   uint32_t	PCCTL;				/*EPWMxն�����ƼĴ�����ƫ��0x2C*/
	volatile	   uint32_t	PXASCTL;			/*EPWMx�ضϿ��ƼĴ�����ƫ��0x30*/
	volatile	   uint32_t	ETCTL;				/*�¼��������ƼĴ�����ƫ��0x34*/
	volatile	   uint32_t	IE;					/*EPWMx�ж�ʹ�ܼĴ�����ƫ��0x38*/
	volatile const uint32_t	IF;					/*EPWMx�жϱ�־�Ĵ�����ƫ��0x3C*/
	volatile	   uint32_t	IC;					/*EPWMx�ж�����Ĵ�����ƫ��0x40*/
	volatile	   uint32_t	DE;					/*EPWMx����DMAʹ�ܼĴ�����ƫ��0x44*/
	volatile const uint32_t	DF;					/*EPWMx����DMA��־�Ĵ�����ƫ��0x48*/
				   uint32_t RESERVED0;        	/* ������ַ, ƫ��:0x4C */
	volatile	   uint32_t	HRPWMCTL;			/*�߾���PWM���ƼĴ�����ƫ��0x50*/
	volatile	   uint32_t	HRCMP;				/*�߾���ռ�ձȼĴ�����ƫ��0x54*/
	volatile const uint32_t	CAP;				/*EPWMx��׽�Ĵ�����ƫ��0x58*/
	volatile	   uint32_t	RC;					/*EPWMxռ�ձ�C�Ĵ�����ƫ��0x5C*/
	volatile	   uint32_t	RD;					/*EPWMxռ�ձ�D�Ĵ�����ƫ��0x60*/
	volatile	   uint32_t	UDCTL;				/*EPWMx���¿��ƼĴ�����ƫ��0x64*/
}EPWM_SFRmap;
...
{
	volatile 	   uint32_t CTL;      			/* HRCAPx���ƼĴ���,ƫ�ƣ�0x000 */
	volatile const uint32_t COUNTER;      		/* HRCAPx�����Ĵ���,ƫ�ƣ�0x004 */
	volatile const uint32_t RISE[2];      		/* HRCAPx������������׽�Ĵ���0,ƫ�ƣ�0x008 */
	volatile const uint32_t FALL[2];      		/* HRCAPx�½���������׽�Ĵ���0,ƫ�ƣ�0x010 */
	volatile const uint32_t HRRISE[2];      		/* HRCAPx������С����׽�Ĵ���0,ƫ�ƣ�0x018 */
	volatile const uint32_t HRFALL[2];      		/* HRCAPx�½���С����׽�Ĵ���0,ƫ�ƣ�0x020 */
	volatile const uint32_t SR;      			/* HRCAPx״̬�Ĵ���,ƫ�ƣ�0x028 */
	volatile       uint32_t SRIC;      			/* HRCAPx״̬����Ĵ���,ƫ�ƣ�0x02C */
	volatile       uint32_t IFRC;      			/* HRCAPx״̬ǿ�ƼĴ���,ƫ�ƣ�0x030 */
}HRCAP_SFRmap;
...
typedef struct ADC_MemMap {
    ...
    volatile       uint32_t HPDOFF0;     /* ADC�����ȼ�ͨ������ƫ�ƼĴ���0, ƫ��:0x34 */
    volatile       uint32_t HPDOFF1;     /* ADC�����ȼ�ͨ������ƫ�ƼĴ���1, ƫ��:0x38 */
    volatile       uint32_t HPDOFF2;     /* ADC�����ȼ�ͨ������ƫ�ƼĴ���2, ƫ��:0x3C */
    volatile       uint32_t HPDOFF3;     /* ADC�����ȼ�ͨ������ƫ�ƼĴ���3, ƫ��:0x40 */
    volatile       uint32_t SCANSQ3;    /* ADC����ͨ��ɨ���������üĴ���3, ƫ��:0x44 */
                   uint32_t RESERVED[2];/* ������ַ, ƫ��:0x48 */
    volatile       uint32_t STATE;      /* ADC״̬�Ĵ���, ƫ��:0x50 */
    volatile       uint32_t DELAY;      /* ����������ʱ�Ĵ���,ADC0����, ƫ��:0x54 */
    volatile	   uint32_t SCANCTL;	/* ADCɨ����ƼĴ���, ƫ��0x58 */
}ADC_SFRmap;
...
{
    volatile uint32_t CTL0;       	/* ģ��Ƚ������ƼĴ���0, ƫ��:0x0 */
    volatile uint32_t CTL1;       	/* ģ��Ƚ������ƼĴ���1, ƫ��:0x4 */
    volatile uint32_t CTL2;       	/* ģ��Ƚ������ƼĴ���2, ƫ��:0x8 */
    volatile uint32_t CTL3;       	/* ģ��Ƚ������ƼĴ���3, ƫ��:0xC */
    volatile uint32_t CTL4;   		/* ģ��Ƚ������ƼĴ���4, ƫ��:0x10 */
    volatile uint32_t CTL5;   		/* ģ��Ƚ������ƼĴ���5, ƫ��:0x14 */
    volatile uint32_t TRIM0;   		/* ģ��Ƚ���У׼�Ĵ���0, ƫ��:0x18 */
    volatile uint32_t TRIM1;   		/* ģ��Ƚ���У׼�Ĵ���1, ƫ��:0x1C */
    volatile uint32_t TRIM2;   		/* ģ��Ƚ���У׼�Ĵ���2, ƫ��:0x20 */
    volatile uint32_t TRIM3;   		/* ģ��Ƚ���У׼�Ĵ���3, ƫ��:0x24 */
}CMP_SFRmap;
...
{
	volatile uint32_t CTL0;       /* ����Ŵ������ƼĴ���0,ƫ�ƣ�0x00 */
	volatile uint32_t CTL1;       /* ����Ŵ������ƼĴ���1,ƫ�ƣ�0x04 */
	volatile uint32_t TRIM0;      /* ����Ŵ���У׼�Ĵ���0,ƫ�ƣ�0x08 */
	volatile uint32_t TRIM1;      /* ����Ŵ���У׼�Ĵ���1,ƫ�ƣ�0x0C */
	volatile uint32_t TRIM2;      /* ����Ŵ���У׼�Ĵ���2,ƫ�ƣ�0x10 */
	volatile uint32_t TRIM3;      /* ����Ŵ���У׼�Ĵ���3,ƫ�ƣ�0x14 */
}OP_SFRmap;
...
{
    volatile uint32_t CTLR;             /* USART���ƼĴ���, ƫ��:0x00 */
    volatile uint32_t BRGR;             /* USART�����ʼĴ���, ƫ��:0x04 */
    volatile uint32_t STR;              /* USART״̬�Ĵ���, ƫ��:0x08 */
    union
    {
        volatile       uint32_t TBUFR;  /* USART�������ݼĴ���, ƫ��:0x0C */
        volatile const uint32_t RBUFR;  /* USART�������ݼĴ���, ƫ��:0x0C */
    };
...
{
    volatile uint32_t BRGR;             /* SPI���ƼĴ���, ƫ��:0x00 */
    volatile uint32_t CTLR;             /* SPI�����ʼĴ���, ƫ��:0x04 */
    volatile uint32_t BUFR;             /* SPI���ݼĴ���, ƫ��:0x08 */
    volatile uint32_t STR;              /* SPI״̬�Ĵ���, ƫ��:0x0C */
}SPI_SFRmap;
...
typedef struct CAN_MemMap
{
    ...
    volatile 	   uint32_t RCR;        /* CAN��¼�Ĵ���, ƫ��:0x8 */
	...
	volatile  uint32_t RXDATA0;	/* CAN���ݽ��ջ���Ĵ���0��ƫ��:0x30*/
	volatile  uint32_t RXDATA1;	/* CAN���ݽ��ջ���Ĵ���1��ƫ��:0x34*/
	volatile  uint32_t RXDATA2;	/* CAN���ݽ��ջ���Ĵ���2��ƫ��:0x38*/
	volatile  uint32_t RXDATA3;	/* CAN���ݽ��ջ���Ĵ���3��ƫ��:0x3C*/

}CAN_SFRmap;

typedef struct CAN_FILTER_Map
{
    volatile       uint32_t ACR1R;       /* CAN���մ���Ĵ���1, ƫ��:0x00 */
    volatile       uint32_t MSK1R;       /* CAN�������μĴ���1, ƫ��:0x04 */
    volatile       uint32_t ACR2R;       /* CAN���մ���Ĵ���2, ƫ��:0x08 */
    volatile       uint32_t MSK2R;       /* CAN�������μĴ���2, ƫ��:0x0C */
    volatile       uint32_t ACR3R;       /* CAN���մ���Ĵ���3, ƫ��:0x10 */
    volatile       uint32_t MSK3R;       /* CAN�������μĴ���3, ƫ��:0x14 */
    volatile       uint32_t ACR4R;       /* CAN���մ���Ĵ���4, ƫ��:0x18 */
    volatile       uint32_t MSK4R;       /* CAN�������μĴ���4, ƫ��:0x1C */
    volatile       uint32_t ACR5R;       /* CAN���մ���Ĵ���5, ƫ��:0x20 */
    volatile       uint32_t MSK5R;       /* CAN�������μĴ���5, ƫ��:0x24 */
    volatile       uint32_t ACR6R;       /* CAN���մ���Ĵ���6, ƫ��:0x28 */
    volatile       uint32_t MSK6R;       /* CAN�������μĴ���6, ƫ��:0x2C */
    volatile       uint32_t ACR7R;       /* CAN���մ���Ĵ���7, ƫ��:0x30 */
    volatile       uint32_t MSK7R;       /* CAN�������μĴ���7, ƫ��:0x34 */
    volatile       uint32_t ACR8R;       /* CAN���մ���Ĵ���8, ƫ��:0x38 */
    volatile       uint32_t MSK8R;       /* CAN�������μĴ���8, ƫ��:0x3C */
}CAN_FILTER_SFRmap;
...
{
	volatile 	   uint32_t 	CTLR0;   		/* CANFD���ƼĴ���0,ƫ�ƣ�0x000 */
	volatile 	   uint32_t 	BRGR;   		/* CANFD�����ʼĴ���,ƫ�ƣ�0x004 */
	volatile const uint32_t 	RCR;      		/* CANFD��¼�Ĵ���,ƫ�ƣ�0x008 */
	volatile 	   uint32_t 	EROR;   		/* CANFD����Ĵ���,ƫ�ƣ�0x00C */
	volatile 	   uint32_t 	NOUSE1;   		/* ռλ                                                                  */
	volatile 	   uint32_t 	MSKR;   		/* CANFD�������μĴ���,ƫ�ƣ�0x014 */
	volatile 	   uint32_t 	IER;   		    /* CANFD�ж�ʹ�ܼĴ���,ƫ�ƣ�0x018 */
	volatile 	   uint32_t 	IFR;   		    /* CANFD�жϱ�־�Ĵ���,ƫ�ƣ�0x01C */
	volatile const uint32_t  	RX_SET1;        /* CANFD���ݽ��ջ���Ĵ���0,ƫ�ƣ�0x020 */
	union
	{
		struct
		{
	...
	volatile 	   uint32_t 	TIMER;   		/* ʱ���������,ƫ�ƣ�0x068 */
	volatile const uint32_t 	CRC;      		/* FLEXCRC�Ĵ���,ƫ�ƣ�0x06C */
	volatile 	   uint32_t 	NOUSE2;   		/* ռλ                                                                     */
	volatile 	   uint32_t 	CTLR1;   		/* CANFD���ƼĴ���1,ƫ�ƣ�0x074 */
	volatile const uint32_t 	AMSTA;      	/* CANFD�ٲ�ƥ��״̬�Ĵ���,ƫ�ƣ�0x078 */
...
typedef struct WWDT_MemMap
{
    ...
    volatile uint32_t CTL1;             /* �������Ź����ƼĴ���1, ƫ��:0x08 */
}WWDT_SFRmap;
...
{
	volatile uint32_t CTL;   /* ��Χ���Ź����ƼĴ���,ƫ�ƣ�0x000 */
	volatile uint32_t CNT;   /* ��Χ���Ź������Ĵ���,ƫ�ƣ�0x004 */
}EWDT_SFRmap;
...
typedef struct ECFGL_MenMap
{
	union
	{
		struct
		{
			volatile	uint32_t ECFGL0_CTL;   		/* ECFGL���ƼĴ���0,ƫ�ƣ�0x00 */
			volatile	uint32_t ECFGL1_CTL;   		/* ECFGL���ƼĴ���1,ƫ�ƣ�0x04 */
			volatile 	uint32_t ECFGL2_CTL;   		/* ECFGL���ƼĴ���2,ƫ�ƣ�0x08 */
			volatile 	uint32_t ECFGL3_CTL;   		/* ECFGL���ƼĴ���3,ƫ�ƣ�0x0C */
			volatile 	uint32_t ECFGL4_CTL;   		/* ECFGL���ƼĴ���4,ƫ�ƣ�0x10 */
			volatile 	uint32_t ECFGL5_CTL;   		/* ECFGL���ƼĴ���5,ƫ�ƣ�0x14 */
			volatile 	uint32_t ECFGL6_CTL;   		/* ECFGL���ƼĴ���6,ƫ�ƣ�0x18 */
			volatile 	uint32_t ECFGL7_CTL;   		/* ECFGL���ƼĴ���7,ƫ�ƣ�0x1C */
			volatile 	uint32_t ECFGL8_CTL;   		/* ECFGL���ƼĴ���8,ƫ�ƣ�0x20 */
			volatile 	uint32_t ECFGL9_CTL;   		/* ECFGL���ƼĴ���9,ƫ�ƣ�0x24 */
			volatile 	uint32_t ECFGL10_CTL;   		/* ECFGL���ƼĴ���10,ƫ�ƣ�0x28 */
			volatile 	uint32_t ECFGL11_CTL;   		/* ECFGL���ƼĴ���11,ƫ�ƣ�0x2C */
			volatile 	uint32_t ECFGL12_CTL;   		/* ECFGL���ƼĴ���12,ƫ�ƣ�0x30 */
			volatile 	uint32_t ECFGL13_CTL;   		/* ECFGL���ƼĴ���13,ƫ�ƣ�0x34 */
			volatile 	uint32_t ECFGL14_CTL;   		/* ECFGL���ƼĴ���14,ƫ�ƣ�0x38 */
			volatile 	uint32_t ECFGL15_CTL;   		/* ECFGL���ƼĴ���15,ƫ�ƣ�0x3C */
		};
		volatile 	   uint32_t ECFGL_CTL[16];   		/* ECFGL���ƼĴ���0,ƫ�ƣ�0x00 */
	};
	volatile 	   uint32_t SOFTSEL;   		/* ECFGL�˲�ʱ�ӿ��ƼĴ���,ƫ�ƣ�0x40 */
	volatile 	   uint32_t FCLK;   		/* ECFGL�˲�ʱ�ӿ��ƼĴ���,ƫ�ƣ�0x44 */
	volatile 	   uint32_t IC;   			/* ECFGL�ж�����Ĵ���,ƫ�ƣ�0x48 */
	volatile 	   uint32_t IF;   			/* ECFGL�жϱ�־�Ĵ���,ƫ�ƣ�0x4C */
	volatile 	   uint32_t RFCTL;   		/* �ж������ؿ��ƼĴ���,ƫ�ƣ�0x50 */
	volatile 	   uint32_t FFCTL;   		/* �ж������ؿ��ƼĴ���,ƫ�ƣ�0x54 */
	volatile 	   uint32_t ADC;   			/* ECFGL����ADC���ƼĴ���,ƫ�ƣ�0x58 */
	volatile const uint32_t OUT;      		/* ECFGL���״̬�Ĵ���,ƫ�ƣ�0x5C */
}ECFGL_SFRmap;
...
#define  PM_CAL0_A01TOA02EN_POS        (30) // 加入 A01切换A02
...
{
	volatile 		uint32_t CTL;			/*	CRC���ƼĴ���,ƫ�ƣ�0x000	*/
	volatile   		uint32_t DATA;			/*	CRC�������ݼĴ���,ƫ�ƣ�0x004	*/
	volatile const  uint32_t RSLT;			/*	CRC����Ĵ���,ƫ�ƣ�0x008	*/
	volatile 		uint32_t INIT;			/*	CRC��ʼֵ�Ĵ���,ƫ�ƣ�0x00C	*/
	volatile 		uint32_t PLN;			/*	CRC����ʽ�Ĵ���,ƫ�ƣ�0x010	*/
	volatile 		uint32_t RXOR;			/*	CRC������ֵ�Ĵ���,ƫ�ƣ�0x014	*/
	volatile 		uint32_t IDATA;			/*	CRC�����Ĵ���,ƫ�ƣ�0x018	*/
	volatile const uint32_t TEMP;			/*	CRC����Ĵ���,ƫ�ƣ�0x01C	*/
...
{
	volatile 	   uint32_t CTL;   /* AES���ƼĴ���,ƫ�ƣ�0x000 */
	volatile 	   uint32_t INT;      /* AES�жϼĴ���,ƫ�ƣ�0x004 */
				   uint32_t RESERVED1;      /* ����,ƫ�ƣ�0x008 */
				   uint32_t RESERVED2;      /* ����,ƫ�ƣ�0x00C */
	volatile 	   uint32_t INPUT0;   /* AES����Ĵ���0,ƫ�ƣ�0x010 */
	volatile 	   uint32_t INPUT1;   /* AES����Ĵ���1,ƫ�ƣ�0x014 */
	volatile 	   uint32_t INPUT2;   /* AES����Ĵ���2,ƫ�ƣ�0x018 */
	volatile 	   uint32_t INPUT3;   /* AES����Ĵ���3,ƫ�ƣ�0x01C */
	volatile const uint32_t OUTPUT0;      /* AES����Ĵ���0,ƫ�ƣ�0x020 */
	volatile const uint32_t OUTPUT1;      /* AES����Ĵ���1,ƫ�ƣ�0x024 */
	volatile const uint32_t OUTPUT2;      /* AES����Ĵ���2,ƫ�ƣ�0x028 */
	volatile const uint32_t OUTPUT3;      /* AES����Ĵ���3,ƫ�ƣ�0x02C */
}AES_SFRmap;
...
{
	volatile 	   uint32_t CTL;			/*	RNG���ƼĴ���,ƫ�ƣ�0x000	*/
	volatile 	   uint32_t STATE;			/*	RNG״̬�Ĵ���,ƫ�ƣ�0x004	*/
	volatile const uint32_t	SEED;			/*	��������ӼĴ���,ƫ�ƣ�0x008	*/
	volatile const uint32_t	DR;				/*	RNG��������ݼĴ���,ƫ�ƣ�0x00C	*/
}RNG_SFRmap;
...
{
	volatile uint32_t SOU;   				/* FlexMUX����Դѡ��Ĵ���,ƫ�ƣ�0x000 */
	volatile uint32_t TAR;   				/* FlexMUX��������ѡ��Ĵ���,ƫ�ƣ�0x004 */
}FlexMUX_SFRmap;
...
{
	volatile 	   uint32_t CTL;   			/* FDCx���ƼĴ���,ƫ�ƣ�0x000 */
	volatile 	   uint32_t MOD;   			/* FDCx�������ڼĴ���,ƫ�ƣ�0x004 */
	volatile const uint32_t CNT;     		/* FDCx�����Ĵ���,ƫ�ƣ�0x008 */
	volatile 	   uint32_t IDLY;   		/* FDCx�ж���ʱ�Ĵ���,ƫ�ƣ�0x00C */
	volatile 	   uint32_t CH0CTL;   		/* FDCxͨ��0���ƼĴ���,ƫ�ƣ�0x010 */
	volatile 	   uint32_t CH1CTL;   		/* FDCxͨ��1���ƼĴ���,ƫ�ƣ�0x014 */
	volatile 	   uint32_t CH2CTL;   		/* FDCxͨ��2���ƼĴ���,ƫ�ƣ�0x018 */
	volatile 	   uint32_t CH3CTL;   		/* FDCxͨ��3���ƼĴ���,ƫ�ƣ�0x01C */
				   uint32_t RESERVED[4];      /* ����,ƫ�ƣ�0x020 */
	volatile 	   uint32_t CH0DLY0;   		/* FDCxͨ��0��ʱ�Ĵ���0,ƫ�ƣ�0x030 */
	volatile 	   uint32_t CH0DLY1;   		/* FDCxͨ��0��ʱ�Ĵ���1,ƫ�ƣ�0x034 */
	volatile 	   uint32_t CH0DLY2;   		/* FDCxͨ��0��ʱ�Ĵ���2,ƫ�ƣ�0x038 */
				   uint32_t RESERVED5;      /* ����,ƫ�ƣ�0x03C */
	volatile 	   uint32_t CH1DLY0;   		/* FDCxͨ��1��ʱ�Ĵ���0,ƫ�ƣ�0x040 */
	volatile 	   uint32_t CH1DLY1;   		/* FDCxͨ��1��ʱ�Ĵ���1,ƫ�ƣ�0x044 */
	volatile 	   uint32_t CH1DLY2;   		/* FDCxͨ��1��ʱ�Ĵ���2,ƫ�ƣ�0x048 */
				   uint32_t RESERVED6;      /* ����,ƫ�ƣ�0x04C */
	volatile 	   uint32_t CH2DLY0;   		/* FDCxͨ��2��ʱ�Ĵ���0,ƫ�ƣ�0x050 */
	volatile 	   uint32_t CH2DLY1;   		/* FDCxͨ��2��ʱ�Ĵ���1,ƫ�ƣ�0x054 */
	volatile 	   uint32_t CH2DLY2;   		/* FDCxͨ��2��ʱ�Ĵ���2,ƫ�ƣ�0x058 */
				   uint32_t RESERVED7;      /* ����,ƫ�ƣ�0x05C */
	volatile 	   uint32_t CH3DLY0;   		/* FDCxͨ��3��ʱ�Ĵ���0,ƫ�ƣ�0x060 */
	volatile 	   uint32_t CH3DLY1;   		/* FDCxͨ��3��ʱ�Ĵ���1,ƫ�ƣ�0x064 */
	volatile 	   uint32_t CH3DLY2;   		/* FDCxͨ��3��ʱ�Ĵ���2,ƫ�ƣ�0x068 */
				   uint32_t RESERVED8;      /* ����,ƫ�ƣ�0x06C */
	volatile 	   uint32_t PO0DLY;   		/* FDCxͨ��0���������ʱ�Ĵ���,ƫ�ƣ�0x070 */
	volatile 	   uint32_t PO1DLY;   		/* FDCxͨ��1���������ʱ�Ĵ���,ƫ�ƣ�0x074 */
	volatile 	   uint32_t PO2DLY;   		/* FDCxͨ��2���������ʱ�Ĵ���,ƫ�ƣ�0x078 */
	volatile 	   uint32_t PO3DLY;   		/* FDCxͨ��3���������ʱ�Ĵ���,ƫ�ƣ�0x07C */
}FDC_SFRmap;
...
{
	volatile uint32_t CTL;   		/* FlexRM���ƼĴ���,ƫ�ƣ�0x000 */
	volatile uint32_t GPSR0;   		/* Portͨ��ѡ��Ĵ���0,ƫ�ƣ�0x004 */
	volatile uint32_t GPSR1;   		/* Portͨ��ѡ��Ĵ���1,ƫ�ƣ�0x008 */
	volatile uint32_t GCSR0;   		/* CHͨ��ѡ��Ĵ���0,ƫ�ƣ�0x00C */
	volatile uint32_t GCSR1;   		/* CHͨ��ѡ��Ĵ���1,ƫ�ƣ�0x010 */
	volatile uint32_t GCSR2;   		/* CHͨ��ѡ��Ĵ���2,ƫ�ƣ�0x014 */
}FlexRM_SFRmap;
...
{
	volatile	uint32_t CTLR;   /* CACHE_CTLR���ƼĴ���,ƫ�ƣ�0x000 */
}CACHE_SFRmap;
