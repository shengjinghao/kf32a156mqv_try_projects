...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_spi.h" 2
...
# 41 "../src/kf32a1x6_spi.c" 2
# 72 "../src/kf32a1x6_spi.c"
void SPI_Reset(SPI_SFRmap* SPIx)
{
    ...
    else if (SPIx == ((SPI_SFRmap *) ((uint32_t)0x40000C80)))
    {
    ...
    else if (SPIx == ((SPI_SFRmap *) ((uint32_t)0x40002080)))
    {
    ...
    else if (SPIx == ((SPI_SFRmap *) ((uint32_t)0x40002100)))
    {
...
void SPI_Slave_PIN_Config (SPI_SFRmap* SPIx,uint32_t Select)
{
    ...
    SPIx->CTLR = SFR_Config(SPIx->CTLR, ~((uint32_t)3<<((14))), Select);
}
# 461 "../src/kf32a1x6_spi.c"
void SPI_Port_Connection_Mode (SPI_SFRmap* SPIx,uint32_t Mode)
{
    ...
    SPIx->CTLR = SFR_Config(SPIx->CTLR, ~((uint32_t)1<<((7))), Mode);
}
# 479 "../src/kf32a1x6_spi.c"
void SPI_Clock_Polarity_Config (SPI_SFRmap* SPIx,uint32_t Polarity)
{
...
void SPI_I2S_Idle_MCK_Outpue_Select(SPI_SFRmap* SPIx,FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((18)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&(SPIx->CTLR)),"i"((18)));
    }
}
# 712 "../src/kf32a1x6_spi.c"
...
RetStatus SPI_Clear_Receive_Overflow_INT_Flag (SPI_SFRmap* SPIx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((SPIx->STR & ((uint32_t)1<<((4))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus SPI_Clear_Transmit_Overflow_INT_Flag (SPI_SFRmap* SPIx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((SPIx->STR & ((uint32_t)1<<((5))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
