...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_epwm.h" 2
...
# 35 "../src/kf32a1x6_epwm.c" 2
# 46 "../src/kf32a1x6_epwm.c"
void EPWM_Reset (EPWM_SFRmap* EPWMx)
{

    ((void)0);

    if (EPWMx == ((EPWM_SFRmap *) (((uint32_t)0x40001A00))))
    {
     RST_CTL2_Peripheral_Reset_Enable(((uint32_t)1<<((8))), TRUE);
     RST_CTL2_Peripheral_Reset_Enable(((uint32_t)1<<((8))), FALSE);
     PCLK_CTL2_Peripheral_Clock_Enable(((uint32_t)1<<((8))), TRUE);
    }
    else if (EPWMx == ((EPWM_SFRmap *) (((uint32_t)0x40001300))))
    {
     RST_CTL2_Peripheral_Reset_Enable(((uint32_t)1<<((9))), TRUE);
     RST_CTL2_Peripheral_Reset_Enable(((uint32_t)1<<((9))), FALSE);
     PCLK_CTL2_Peripheral_Clock_Enable(((uint32_t)1<<((9))), TRUE);
    }
    else if (EPWMx == ((EPWM_SFRmap *) (((uint32_t)0x40001380))))
    {
     RST_CTL2_Peripheral_Reset_Enable(((uint32_t)1<<((10))), TRUE);
     RST_CTL2_Peripheral_Reset_Enable(((uint32_t)1<<((10))), FALSE);
     PCLK_CTL2_Peripheral_Clock_Enable(((uint32_t)1<<((10))), TRUE);
    }
    else if (EPWMx == ((EPWM_SFRmap *) (((uint32_t)0x40002E00))))
    {
     RST_CTL2_Peripheral_Reset_Enable(((uint32_t)1<<((11))), TRUE);
     RST_CTL2_Peripheral_Reset_Enable(((uint32_t)1<<((11))), FALSE);
     PCLK_CTL2_Peripheral_Clock_Enable(((uint32_t)1<<((11))), TRUE);
    }
    else
    {
     ;
...
void EPWM_Response_UpperLevel_LINK_Enable(EPWM_SFRmap* EPWMx, FunctionalState NewState)
{
 ...
 tmpreg = NewState << (31);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((31))), tmpreg);
}
...
void EPWM_NextLevel_LINK_Ask_Enable(EPWM_SFRmap* EPWMx, FunctionalState NewState)
{
 ...
 tmpreg = NewState << (30);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((30))), tmpreg);
}
...
void EPWM_SYNC_Single_Trigger_Enable(EPWM_SFRmap* EPWMx, FunctionalState NewState)
{
 ...
 tmpreg = NewState << (29);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((29))), tmpreg);
}
# 254 "../src/kf32a1x6_epwm.c"
...
FlagStatus EPWM_Get_CountValue_MAX_Status(EPWM_SFRmap* EPWMx)
{
 ...
 return ((EPWMx->CTL & ((uint32_t)1<<((19)))) >> (19));
}
...
RetStatus EPWM_Clear_CountValue_MAX_Status(EPWM_SFRmap* EPWMx)
{
 ...
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((19))), ((uint32_t)1<<((19))));
 while((!(EPWMx->CTL & ((uint32_t)1<<((19)))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
 if(wait_flag==(0xFFFF))
...
void EPWM_Phase_Direction_Config(EPWM_SFRmap* EPWMx, uint32_t Direction)
{
 ...
 tmpreg = Direction << (18);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((18))), tmpreg);
}
...
void EPWM_Software_SYNC_Event(EPWM_SFRmap* EPWMx)
{
 ...
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((17))), ((uint32_t)1<<((17))));
}
# 385 "../src/kf32a1x6_epwm.c"
void EPWM_SYNC_Event_Out_Select(EPWM_SFRmap* EPWMx, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 tmpreg = Select << (15);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)0x03<<((15))), tmpreg);
}
...
void EPWM_Phase_Register_Loading_Enable(EPWM_SFRmap* EPWMx, FunctionalState NewState)
{
 ...
 tmpreg = NewState << (14);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((14))), tmpreg);
}
...
FlagStatus EPWM_Get_External_SYNC_Event_Status(EPWM_SFRmap* EPWMx)
{
 ...
 return ((EPWMx->CTL & ((uint32_t)1<<((13)))) >> (13));
}
...
RetStatus EPWM_Clear_External_SYNC_Event_Status(EPWM_SFRmap* EPWMx)
{
 ...
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((13))), ((uint32_t)1<<((13))));
 while((!(EPWMx->CTL & ((uint32_t)1<<((13)))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
 if(wait_flag==(0xFFFF))
...
void EPWM_Updata_Event_Generate_Enable(EPWM_SFRmap* EPWMx, FunctionalState NewState)
{
 ...
 tmpreg = NewState << (12);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((12))), tmpreg);
}
# 475 "../src/kf32a1x6_epwm.c"
void EPWM_Updata_Event_Config(EPWM_SFRmap* EPWMx, FunctionalState NewState)
{
 uint32_t tmpreg;
 ...
 tmpreg = NewState << (11);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((11))), tmpreg);
}
...
void EPWM_Updata_Event_Enable(EPWM_SFRmap* EPWMx, FunctionalState NewState)
{
 ...
 tmpreg = NewState << (10);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((10))), tmpreg);
}
# 514 "../src/kf32a1x6_epwm.c"
void EPWM_Counter_Mode_Select(EPWM_SFRmap* EPWMx, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 tmpreg = Select << (7);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)0x07<<((7))), tmpreg);
}
...
FlagStatus EPWM_Get_Tx_Count_Direction(EPWM_SFRmap* EPWMx)
{
 ...
 return ((EPWMx->CTL & ((uint32_t)1<<((6)))) >> (6));
}
# 546 "../src/kf32a1x6_epwm.c"
void EPWM_Work_Clock_Select(EPWM_SFRmap* EPWMx, uint32_t CLK)
{
 uint32_t tmpreg;
 ...
 tmpreg = CLK << (4);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)0x03<<((4))), tmpreg);
}
# 565 "../src/kf32a1x6_epwm.c"
void EPWM_External_Pulse_Sync_Config(EPWM_SFRmap* EPWMx, FunctionalState NewState)
{
 uint32_t tmpreg;
 ...
 tmpreg = NewState << (3);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((3))), tmpreg);
}
...
void EPWM_Gated_Enable(EPWM_SFRmap* EPWMx, FunctionalState NewState)
{
 ...
 tmpreg = NewState << (2);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((2))), tmpreg);
}
# 602 "../src/kf32a1x6_epwm.c"
void EPWM_Work_Mode_Config(EPWM_SFRmap* EPWMx, uint32_t Mode)
{
 uint32_t tmpreg;
 ...
 tmpreg = Mode << (1);
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((1))), tmpreg);
}
...
void EPWM_Enable(EPWM_SFRmap* EPWMx, FunctionalState NewState)
{
 ...
 EPWMx->CTL = SFR_Config(EPWMx->CTL, ~((uint32_t)1<<((0))), NewState);
}
# 640 "../src/kf32a1x6_epwm.c"
void EPWM_Duty_Cycle_RegisterABCD_Config(EPWM_SFRmap* EPWMx, uint32_t Register,uint32_t Value)
{
 ...
 else if(Register == ((uint32_t)1))
 {
  EPWMx->RB = Value;
 }
 else if(Register == ((uint32_t)2))
 {
  EPWMx->RC = Value;
 }
 else if(Register == ((uint32_t)3))
 {
  EPWMx->RD = Value;
 }
}
# 673 "../src/kf32a1x6_epwm.c"
uint32_t EPWM_Get_Duty_Cycle_RegisterABCD_Value(EPWM_SFRmap* EPWMx, uint32_t Register)
{
...
void EPWM_Single_Mandatory_Output_Enable(EPWM_SFRmap* EPWMx,uint32_t Register, FunctionalState NewState)
{
 ...
 if(Register == ((uint32_t)0))
 {
  EPWMx->CTLA = SFR_Config(EPWMx->CTLA, ~((uint32_t)1<<((16))), tmpreg);
 }
 else if(Register == ((uint32_t)1))
 {
  EPWMx->CTLB = SFR_Config(EPWMx->CTLB, ~((uint32_t)1<<((16))), tmpreg);
 }
}
# 737 "../src/kf32a1x6_epwm.c"
void EPWM_Single_Mandatory_Output_Config(EPWM_SFRmap* EPWMx, uint32_t Register, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 if(Register == ((uint32_t)0))
 {
  EPWMx->CTLA = SFR_Config(EPWMx->CTLA, ~((uint32_t)0x03<<((14))), tmpreg);
 }
 else if(Register == ((uint32_t)1))
 {
  EPWMx->CTLB = SFR_Config(EPWMx->CTLB, ~((uint32_t)0x03<<((14))), tmpreg);
 }
}
# 767 "../src/kf32a1x6_epwm.c"
void EPWM_Continuous_Mandatory_Output_Config(EPWM_SFRmap* EPWMx, uint32_t Register, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 if(Register == ((uint32_t)0))
 {
  EPWMx->CTLA = SFR_Config(EPWMx->CTLA, ~((uint32_t)0x03<<((12))), tmpreg);
 }
 else if(Register == ((uint32_t)1))
 {
  EPWMx->CTLB = SFR_Config(EPWMx->CTLB, ~((uint32_t)0x03<<((12))), tmpreg);
 }
}
# 803 "../src/kf32a1x6_epwm.c"
void EPWM_EPWMxAB_OUTPUT_Select(EPWM_SFRmap* EPWMx,uint32_t Register, uint32_t Event, uint32_t Select)
{
 uint32_t tmpreg;
 uint32_t tmask;
...
void EPWM_Dead_Zone_Input_Select(EPWM_SFRmap* EPWMx, uint32_t Select)
{
 ...
 tmpreg = Select << (4);
 EPWMx->DBCTL = SFR_Config(EPWMx->DBCTL, ~((uint32_t)0x03<<((4))), tmpreg);
}
# 858 "../src/kf32a1x6_epwm.c"
void EPWM_Dead_Zone_Output_Polarity_Select(EPWM_SFRmap* EPWMx, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 tmpreg = Select << (2);
 EPWMx->DBCTL = SFR_Config(EPWMx->DBCTL, ~((uint32_t)0x03<<((2))), tmpreg);
}
# 878 "../src/kf32a1x6_epwm.c"
void EPWM_Dead_Zone_Output_Select(EPWM_SFRmap* EPWMx, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 tmpreg = Select << (0);
 EPWMx->DBCTL = SFR_Config(EPWMx->DBCTL, ~((uint32_t)0x03<<((0))), tmpreg);
}
# 897 "../src/kf32a1x6_epwm.c"
void EPWM_Dead_Zone_Time_Config(EPWM_SFRmap* EPWMx, uint32_t Select, uint32_t Value)
{
 ...
 if(Select == ((uint32_t)1))
 {
  EPWMx->DBT = SFR_Config(EPWMx->DBT, ~((uint32_t)0xFFFF<<((16))), Value << (16));
 }
 else if(Select == ((uint32_t)0))
 {
  EPWMx->DBT = SFR_Config(EPWMx->DBT, ~((uint32_t)0xFFFF<<((0))), Value);
 }
}
# 929 "../src/kf32a1x6_epwm.c"
void EPWM_PCLK_Frequency_Config(EPWM_SFRmap* EPWMx, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 tmpreg = Select << (8);
 EPWMx->PCCTL = SFR_Config(EPWMx->PCCTL, ~((uint32_t)0x07<<((8))), tmpreg);
}
# 952 "../src/kf32a1x6_epwm.c"
void EPWM_PCLK_Duty_Cycle_Config(EPWM_SFRmap* EPWMx, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 tmpreg = Select << (5);
 EPWMx->PCCTL = SFR_Config(EPWMx->PCCTL, ~((uint32_t)0x07<<((5))), tmpreg);
}
# 984 "../src/kf32a1x6_epwm.c"
void EPWM_Chopping_Pulse_Width_Config(EPWM_SFRmap* EPWMx, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 tmpreg = Select << (1);
 EPWMx->PCCTL = SFR_Config(EPWMx->PCCTL, ~((uint32_t)0x0F<<((1))), tmpreg);
}
...
void EPWM_Chopping_Pulse_Mode_Enable(EPWM_SFRmap* EPWMx, FunctionalState NewState)
{
 ...
 EPWMx->PCCTL = SFR_Config(EPWMx->PCCTL, ~((uint32_t)1<<((0))), NewState);
}
# 1019 "../src/kf32a1x6_epwm.c"
void EPWM_Auto_Reset_Enable(EPWM_SFRmap* EPWMx, uint32_t NewState)
{
 uint32_t tmpreg;
 ...
 tmpreg = NewState << (8);
 EPWMx->PXASCTL = SFR_Config(EPWMx->PXASCTL, ~((uint32_t)1<<((8))), tmpreg);
}
# 1038 "../src/kf32a1x6_epwm.c"
void EPWM_Pin_EPWMA_ShouDown_Status_Config(EPWM_SFRmap* EPWMx, uint32_t Status)
{
 uint32_t tmpreg;
 ...
 tmpreg = Status << (6);
 EPWMx->PXASCTL = SFR_Config(EPWMx->PXASCTL, ~((uint32_t)0x03<<((6))), tmpreg);
}
# 1057 "../src/kf32a1x6_epwm.c"
void EPWM_Pin_EPWMB_ShouDown_Status_Config(EPWM_SFRmap* EPWMx, uint32_t Status)
{
 uint32_t tmpreg;
 ...
 tmpreg = Status << (4);
 EPWMx->PXASCTL = SFR_Config(EPWMx->PXASCTL, ~((uint32_t)0x03<<((4))), tmpreg);
}
...
FlagStatus EPWM_Get_Auto_ShowDown_Event_Status(EPWM_SFRmap* EPWMx)
{
 ...
 return ((EPWMx->PXASCTL & ((uint32_t)1<<((3)))) >> (3));
}
...
void EPWM_Claer_Auto_ShowDown_Event_Status(EPWM_SFRmap* EPWMx)
{
 ...
 EPWMx->PXASCTL &= ~((uint32_t)1<<((3)));
}
# 1105 "../src/kf32a1x6_epwm.c"
void EPWM_Auto_ShowDown_Source_Select(EPWM_SFRmap* EPWMx, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 tmpreg = Select << (0);
 EPWMx->PXASCTL = SFR_Config(EPWMx->PXASCTL, ~((uint32_t)0x07<<((0))), tmpreg);
}
# 1128 "../src/kf32a1x6_epwm.c"
void EPWM_Trigger_AD_Event_Mode_Select(EPWM_SFRmap* EPWMx, uint32_t Event, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 {
  tmpreg = Select << (24);
  EPWMx->ETCTL = SFR_Config(EPWMx->ETCTL, ~((uint32_t)0x03<<((24))), tmpreg);
 }
 else if(Event == ((uint32_t)0))
 {
  tmpreg = Select << (8);
  EPWMx->ETCTL = SFR_Config(EPWMx->ETCTL, ~((uint32_t)0x03<<((8))), tmpreg);
 }
}
...
EPWM_Get_Trigger_AD_Event_Single(EPWM_SFRmap* EPWMx, uint32_t Event)
{
 ...
 if(Event == ((uint32_t)1))
 {
  return ((EPWMx->ETCTL & ((uint32_t)0x03<<((22)))) >> (22));
 }
 else if(Event == ((uint32_t)0))
 {
  return ((EPWMx->ETCTL & ((uint32_t)0x03<<((6)))) >> (6));
 }
}
# 1184 "../src/kf32a1x6_epwm.c"
void EPWM_Trigger_Event_Cycle_Select(EPWM_SFRmap* EPWMx, uint32_t Event, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 {
  tmpreg = Select << (20);
  EPWMx->ETCTL = SFR_Config(EPWMx->ETCTL, ~((uint32_t)0x03<<((20))), tmpreg);
 }
 else if(Event == ((uint32_t)0))
 {
  tmpreg = Select << (4);
  EPWMx->ETCTL = SFR_Config(EPWMx->ETCTL, ~((uint32_t)0x03<<((4))), tmpreg);
 }
}
# 1213 "../src/kf32a1x6_epwm.c"
void EPWM_Software_Trigger_AD_Event_Enable(EPWM_SFRmap* EPWMx, uint32_t Event, FunctionalState NewState)
{
 uint32_t tmpreg;
 ...
 {
  tmpreg = NewState << (20);
  EPWMx->ETCTL = SFR_Config(EPWMx->ETCTL, ~((uint32_t)1<<((19))), tmpreg);
 }
 else if(Event == ((uint32_t)0))
 {
  tmpreg = NewState << (19);
  EPWMx->ETCTL = SFR_Config(EPWMx->ETCTL, ~((uint32_t)1<<((3))), tmpreg);
 }
}
# 1244 "../src/kf32a1x6_epwm.c"
void EPWM_Trigger_AD_Event_Select(EPWM_SFRmap* EPWMx, uint32_t Event, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 {
  tmpreg = Select << (17);
  EPWMx->ETCTL = SFR_Config(EPWMx->ETCTL, ~((uint32_t)0x03<<((17))), tmpreg);
 }
 else if(Event == ((uint32_t)0))
 {
  tmpreg = Select << (1);
  EPWMx->ETCTL = SFR_Config(EPWMx->ETCTL, ~((uint32_t)0x03<<((1))), tmpreg);
 }
}
# 1273 "../src/kf32a1x6_epwm.c"
void EPWM_Trigger_AD_Event_Enable(EPWM_SFRmap* EPWMx, uint32_t Event, FunctionalState NewState)
{
 uint32_t tmpreg;
 ...
 {
  tmpreg = NewState << (16);
  EPWMx->ETCTL = SFR_Config(EPWMx->ETCTL, ~((uint32_t)1<<((16))), tmpreg);
 }
 else if(Event == ((uint32_t)0))
 {
  tmpreg = NewState << (0);
  EPWMx->ETCTL = SFR_Config(EPWMx->ETCTL, ~((uint32_t)1<<((0))), tmpreg);
 }
}
# 1312 "../src/kf32a1x6_epwm.c"
void EPWM_INT_Enable(EPWM_SFRmap* EPWMx, uint32_t Select, FunctionalState NewState)
{
 uint32_t tmpreg;
 uint32_t tmask;
...
RetStatus EPWM_Clear_INT_Flag(EPWM_SFRmap* EPWMx, uint32_t Select)
{
 ...
 while((EPWMx->IF & tmask)&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
void EPWM_HRPWM_OUTPUTB_CONTRAL_Select(EPWM_SFRmap* EPWMx, uint32_t Select)
{
 ...
 tmpreg = Select << (1);
 EPWMx->HRPWMCTL = SFR_Config(EPWMx->HRPWMCTL, ~((uint32_t)1<<((1))), tmpreg);
}
...
void EPWM_HRPWM_Enable(EPWM_SFRmap* EPWMx, FunctionalState NewState)
{
 ...
 EPWMx->HRPWMCTL = SFR_Config(EPWMx->HRPWMCTL, ~((uint32_t)1<<((0))), NewState);
}
...
void EPWM_Global_Loading_Enable(EPWM_SFRmap* EPWMx, FunctionalState NewState)
{
 ...
 tmpreg = NewState << (27);
 EPWMx->UDCTL = SFR_Config(EPWMx->UDCTL, ~((uint32_t)1<<((27))), tmpreg);
}
