...
.Ltext0:
	...
	.stabs	"D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_wwdt.h",130,0,0,0
	...
	.text$WWDT_Reset$scode_loacal_1:
	.align	1
	.stabs	"WWDT_Reset:F(0,15)",36,0,46,WWDT_Reset
	.export	WWDT_Reset
	.type	WWDT_Reset, @function
WWDT_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_wwdt.c",132,0,0,.Ltext1
.Ltext1:
...
.Lscope1:
	...
	.text$WWDT_Threshold_Config$scode_loacal_2:
	.align	1
	.stabs	"WWDT_Threshold_Config:F(0,15)",36,0,61,WWDT_Threshold_Config
	.stabs	"Threshold:P(4,6)",64,0,61,0
	.export	WWDT_Threshold_Config
	.type	WWDT_Threshold_Config, @function
WWDT_Threshold_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_wwdt.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,62,.LM5-.LFBB2
.LM5:
.LFBB2:
...
.LBE9:
.LBE8:
	.stabs	"../src/kf32a1x6_wwdt.c",132,0,0,.Ltext4
.Ltext4:
...
.Lscope2:
	...
	.text$WWDT_Prescaler_Config$scode_loacal_3:
	.align	1
	.stabs	"WWDT_Prescaler_Config:F(0,15)",36,0,97,WWDT_Prescaler_Config
	.stabs	"Prescaler:P(4,6)",64,0,97,0
	.export	WWDT_Prescaler_Config
	.type	WWDT_Prescaler_Config, @function
WWDT_Prescaler_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_wwdt.c",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,98,.LM11-.LFBB3
.LM11:
.LFBB3:
	.stabn	68,0,103,.LM12-.LFBB3
.LM12:
	LD	r5,#1073746560
	LD.w	r3,[r5]
.LBB10:
...
.LBE11:
.LBE10:
	.stabs	"../src/kf32a1x6_wwdt.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,103,.LM14-.LFBB3
.LM14:
	ST.w	[r5],r0
...
.Lscope3:
	...
	.text$WWDT_Work_CLK_Selest$scode_loacal_4:
	.align	1
	.stabs	"WWDT_Work_CLK_Selest:F(0,15)",36,0,115,WWDT_Work_CLK_Selest
	.stabs	"Source:P(4,6)",64,0,115,0
	.export	WWDT_Work_CLK_Selest
	.type	WWDT_Work_CLK_Selest, @function
WWDT_Work_CLK_Selest:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_wwdt.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,116,.LM16-.LFBB4
.LM16:
.LFBB4:
...
.LBE13:
.LBE12:
	.stabs	"../src/kf32a1x6_wwdt.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,120,.LM19-.LFBB4
.LM19:
	ST.w	[r5+#2],r0
	.stabn	68,0,121,.LM20-.LFBB4
.LM20:
	JMP	lr
...
.Lscope4:
	...
	.text$WWDT_Enable$scode_loacal_5:
	.align	1
	.stabs	"WWDT_Enable:F(0,15)",36,0,128,WWDT_Enable
	.stabs	"NewState:P(3,2)",64,0,128,0
	.export	WWDT_Enable
	.type	WWDT_Enable, @function
WWDT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_wwdt.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,129,.LM21-.LFBB5
.LM21:
.LFBB5:
	.stabn	68,0,137,.LM22-.LFBB5
.LM22:
	LD	r5,#1073746560
	.stabn	68,0,134,.LM23-.LFBB5
.LM23:
	CMP	r0,#0
	JNZ	.L9
	.stabn	68,0,142,.LM24-.LFBB5
.LM24:
// inline asm begin
	// 142 "../src/kf32a1x6_wwdt.c" 1
	CLR [r5], #0
	.stabn	68,0,144,.LM25-.LFBB5
.LM25:
// inline asm end
	JMP	lr
.L9:
...
.LM26:
// inline asm begin
	// 137 "../src/kf32a1x6_wwdt.c" 1
	SET [r5], #0
	.stabn	68,0,144,.LM27-.LFBB5
.LM27:
// inline asm end
	JMP	lr
...
.Lscope5:
	...
	.text$WWDT_Counter_Config$scode_loacal_6:
	.align	1
	.stabs	"WWDT_Counter_Config:F(0,15)",36,0,151,WWDT_Counter_Config
	.stabs	"Counter:P(4,6)",64,0,151,0
	.export	WWDT_Counter_Config
	.type	WWDT_Counter_Config, @function
WWDT_Counter_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_wwdt.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,152,.LM28-.LFBB6
.LM28:
.LFBB6:
	.stabn	68,0,157,.LM29-.LFBB6
.LM29:
	LD	r5,#1073746560
	ST.w	[r5+#1],r0
	.stabn	68,0,158,.LM30-.LFBB6
.LM30:
	JMP	lr
...
.Lscope6:
	...
	.text$WWDT_Get_Counter$scode_loacal_7:
	.align	1
	.stabs	"WWDT_Get_Counter:F(4,6)",36,0,165,WWDT_Get_Counter
	.export	WWDT_Get_Counter
	.type	WWDT_Get_Counter, @function
WWDT_Get_Counter:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_wwdt.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,166,.LM31-.LFBB7
.LM31:
.LFBB7:
	.stabn	68,0,170,.LM32-.LFBB7
.LM32:
	LD	r5,#1073746560
	LD.w	r0,[r5+#1]
	.stabn	68,0,174,.LM33-.LFBB7
.LM33:
	MOV	r5,#127
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope7:
	...
	.text$WWDT_INT_Enable$scode_loacal_8:
	.align	1
	.stabs	"WWDT_INT_Enable:F(0,15)",36,0,188,WWDT_INT_Enable
	.stabs	"NewState:P(3,2)",64,0,188,0
	.export	WWDT_INT_Enable
	.type	WWDT_INT_Enable, @function
WWDT_INT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_wwdt.c",132,0,0,.Ltext14
.Ltext14:
	.stabn	68,0,189,.LM34-.LFBB8
.LM34:
.LFBB8:
	.stabn	68,0,197,.LM35-.LFBB8
.LM35:
	LD	r5,#1073746560
	.stabn	68,0,194,.LM36-.LFBB8
.LM36:
	CMP	r0,#0
	JNZ	.L15
	.stabn	68,0,202,.LM37-.LFBB8
.LM37:
// inline asm begin
	// 202 "../src/kf32a1x6_wwdt.c" 1
	CLR [r5], #1
	.stabn	68,0,204,.LM38-.LFBB8
.LM38:
// inline asm end
	JMP	lr
.L15:
	.stabn	68,0,197,.LM39-.LFBB8
.LM39:
// inline asm begin
	// 197 "../src/kf32a1x6_wwdt.c" 1
	SET [r5], #1
	.stabn	68,0,204,.LM40-.LFBB8
.LM40:
// inline asm end
	JMP	lr
...
.Lscope8:
	...
	.text$WWDT_Get_INT_Flag$scode_loacal_9:
	.align	1
	.stabs	"WWDT_Get_INT_Flag:F(3,4)",36,0,211,WWDT_Get_INT_Flag
	.export	WWDT_Get_INT_Flag
	.type	WWDT_Get_INT_Flag, @function
WWDT_Get_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_wwdt.c",132,0,0,.Ltext15
.Ltext15:
	.stabn	68,0,212,.LM41-.LFBB9
.LM41:
.LFBB9:
	.stabn	68,0,214,.LM42-.LFBB9
.LM42:
	LD	r5,#1073746560
	LD.w	r0,[r5]
	LSR	r0,#2
	.stabn	68,0,224,.LM43-.LFBB9
.LM43:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope9:
	...
	.text$WWDT_Clear_INT_Flag$scode_loacal_10:
	.align	1
	.stabs	"WWDT_Clear_INT_Flag:F(3,7)",36,0,231,WWDT_Clear_INT_Flag
	.export	WWDT_Clear_INT_Flag
	.type	WWDT_Clear_INT_Flag, @function
WWDT_Clear_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_wwdt.c",132,0,0,.Ltext16
.Ltext16:
	.stabn	68,0,232,.LM44-.LFBB10
.LM44:
.LFBB10:
	.stabn	68,0,235,.LM45-.LFBB10
.LM45:
	LD	r5,#1073746560
// inline asm begin
	// 235 "../src/kf32a1x6_wwdt.c" 1
	SET [r5], #15
	.stabn	68,0,236,.LM46-.LFBB10
.LM46:
// inline asm end
	LD	r2,#1073746560
	LD.w	r5,[r2]
...
.L19:
	...
	JZ	.L23
.L20:
	.stabn	68,0,238,.LM47-.LFBB10
.LM47:
	ADD	r5,r5,#1
	.stabn	68,0,236,.LM48-.LFBB10
.LM48:
	LD.w	r4,[r2]
	ANL	r4,r4,r3
	JNZ	.L19
	...
	LSR	r0,r5,r4
.L18:
	.stabn	68,0,240,.LM49-.LFBB10
.LM49:
	LD	r3,#1073746560
// inline asm begin
	// 240 "../src/kf32a1x6_wwdt.c" 1
	CLR [r3], #15
	.stabn	68,0,246,.LM50-.LFBB10
.LM50:
// inline asm end
	JMP	lr
.L23:
	.stabn	68,0,236,.LM51-.LFBB10
.LM51:
	MOV	r0,#0
	.stabn	68,0,240,.LM52-.LFBB10
.LM52:
	LD	r3,#1073746560
// inline asm begin
	// 240 "../src/kf32a1x6_wwdt.c" 1
	CLR [r3], #15
	.stabn	68,0,246,.LM53-.LFBB10
.LM53:
// inline asm end
	JMP	lr
.L21:
	.stabn	68,0,236,.LM54-.LFBB10
.LM54:
	MOV	r0,#1
	JMP	.L18
	.size	WWDT_Clear_INT_Flag, .-WWDT_Clear_INT_Flag
	.stabs	"wait_flag:r(4,6)",64,0,233,5
