 ...
 ******************************************************************************
 *  $File Name$       : kf32a1x6_usart.h                               	      *
 *  $Author$          : ChipON AE/FAE Group                                   *
 *  $Data$            : 2021-07-08                                            *
 *  $AutoSAR Version  : V2.0                                          	      *
 *  $Description$     : This file contains the headers of the USART			  *
 *						peripherals.										  *
 ******************************************************************************
 ...
 *                                                                            *
 *****************************************************************************/
#ifndef KF32A1x6_USART_H_
#define KF32A1x6_USART_H_
...
#define USART_CPOL_HIGH                 ((uint32_t)0<<USART_CTLR_SCKPS_POS)
 ...
 * USART间隔字符长度选择
 * */
#define USART_BLENGTH_13BIT				((uint32_t)0<<USART_CTLR_BKPWS_POS)
#define USART_BLENGTH_16BIT				((uint32_t)1<<USART_CTLR_BKPWS_POS)
#define CHECK_USART_BLENGTH(SEL)      (((SEL) == USART_BLENGTH_13BIT) \
                                     || ((SEL) == USART_BLENGTH_16BIT))
