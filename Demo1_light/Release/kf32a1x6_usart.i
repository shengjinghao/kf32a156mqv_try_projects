# 1 "../src/kf32a1x6_usart.c"
# 1 "D:\\KungFu32\\workspace32\\Demo1_light\\Release//"
# 1 "<command-line>"
# 1 "../src/kf32a1x6_usart.c"
# 37 "../src/kf32a1x6_usart.c"
# 1 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_usart.h" 1
# 29 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_usart.h"
...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_usart.h" 2
...
# 40 "../src/kf32a1x6_usart.c" 2
# 82 "../src/kf32a1x6_usart.c"
void USART_Reset (USART_SFRmap* USARTx)
{
...
void USART_Send_Blank_Length_Config(USART_SFRmap* USARTx, uint32_t UBLength)
{
    ...
    USARTx->CTLR = SFR_Config(USARTx->CTLR, ~((uint32_t)1<<((26))), UBLength);
}
...
RetStatus USART_SendData(USART_SFRmap* USARTx, uint8_t Data)
{
 uint32_t wait_flag=0x0000,wait_flag1=0x0000;
    ...
    USARTx->TBUFR = Data;
    while(((USARTx->STR & ((uint32_t)1<<((12)))))&& (wait_flag1 != (0xFFFF)))
 {
  wait_flag1++;
 }
    while((!(USARTx->STR & ((uint32_t)1<<((13)))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
 if((wait_flag==(0xFFFF))||(wait_flag1==(0xFFFF)))
 {
  return FAILURE;
 }
 return SUCCESS;
...
RetStatus USART_Clear_Receive_Overflow_INT_Flag (USART_SFRmap* USARTx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((USARTx->STR & ((uint32_t)1<<((0))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus USART_Clear_Parity_ERROR_INT_Flag (USART_SFRmap* USARTx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((USARTx->STR & ((uint32_t)1<<((1))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus USART_Clear_Frame_ERROR_INT_Flag (USART_SFRmap* USARTx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((USARTx->STR & ((uint32_t)1<<((2))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus USART_Clear_Blank_INT_Flag (USART_SFRmap* USARTx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((USARTx->STR & ((uint32_t)1<<((3))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus USART_Clear_Idle_INT_Flag (USART_SFRmap* USARTx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((USARTx->STR & ((uint32_t)1<<((15))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus USART_Clear_Auto_BaudRate_TimeOver_INT_Flag (USART_SFRmap* USARTx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((USARTx->STR & ((uint32_t)1<<((4))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus USART_Clear_WeakUP_INT_Flag (USART_SFRmap* USARTx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((USARTx->STR & ((uint32_t)1<<((5))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus USART_Clear_Transmit_ERROR_INT_Flag (USART_SFRmap* USARTx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((USARTx->STR & ((uint32_t)1<<((6))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus USART_Clear_Receive_ERROR_INT_Flag (USART_SFRmap* USARTx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((USARTx->STR & ((uint32_t)1<<((7))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus USART_Clear_CTS_INT_Flag (USART_SFRmap* USARTx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((USARTx->STR & ((uint32_t)1<<((8))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus USART_Clear_Receive_BUFR_INT_Flag (USART_SFRmap* USARTx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((USARTx->STR & ((uint32_t)1<<((11))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus USART_Clear_Transmit_BUFR_INT_Flag (USART_SFRmap* USARTx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((!((USARTx->STR & ((uint32_t)1<<((12))))>>(12)))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
