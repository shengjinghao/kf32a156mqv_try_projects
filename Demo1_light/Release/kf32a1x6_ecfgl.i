# 1 "../src/kf32a1x6_ecfgl.c"
# 1 "D:\\KungFu32\\workspace32\\Demo1_light\\Release//"
# 1 "<command-line>"
# 1 "../src/kf32a1x6_ecfgl.c"
# 31 "../src/kf32a1x6_ecfgl.c"
# 1 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_ecfgl.h" 1
# 29 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_ecfgl.h"
...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_ecfgl.h" 2
...
# 34 "../src/kf32a1x6_ecfgl.c" 2
# 44 "../src/kf32a1x6_ecfgl.c"
void ECFGL_Reset (void)
{

    RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((26))), TRUE);
    RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((26))), FALSE);

    PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((26))), TRUE);
}
# 60 "../src/kf32a1x6_ecfgl.c"
void ECFGL_Output_Enable(uint32_t ECFGLx, FunctionalState NewState)
{
 uint32_t tmpreg;
 uint32_t tmask;
 ...
 tmpreg = NewState << (12);
 tmask = ((uint32_t)1<<((12)));
 ((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->ECFGL_CTL[ECFGLx] = SFR_Config(((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->ECFGL_CTL[ECFGLx], ~tmask, tmpreg);
}
# 94 "../src/kf32a1x6_ecfgl.c"
void ECFGL_Function_Select(uint32_t ECFGLx, uint32_t Function)
{
 uint32_t tmpreg;
 uint32_t tmask;
...
void ECFGL_MUX1IN_Select(uint32_t ECFGLx, uint32_t Select)
{
 ...
 tmpreg = Select << (2);
 tmask = ((uint32_t)0x03<<((2)));
 ((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->ECFGL_CTL[ECFGLx] = SFR_Config(((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->ECFGL_CTL[ECFGLx], ~tmask, tmpreg);
}
# 198 "../src/kf32a1x6_ecfgl.c"
void ECFGL_MUX0IN_Select(uint32_t ECFGLx, uint32_t Select)
{
 uint32_t tmpreg;
 uint32_t tmask;
 ...
 tmpreg = Select << (0);
 tmask = ((uint32_t)0x03<<((0)));
 ((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->ECFGL_CTL[ECFGLx] = SFR_Config(((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->ECFGL_CTL[ECFGLx], ~tmask, tmpreg);
}
# 220 "../src/kf32a1x6_ecfgl.c"
void ECFGL_MUX2IN_Software_Bit_Select(uint32_t ECFGLx, uint32_t Select)
{
 uint32_t tmpreg;
 uint32_t tmask;
 ...
 tmask = 1 << ECFGLx;
 (((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->SOFTSEL) = SFR_Config((((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->SOFTSEL), ~tmask, tmpreg);
}
# 242 "../src/kf32a1x6_ecfgl.c"
void ECFGL_Fliter_Clock_Div_Select(uint32_t ECFGL_DIV)
{
 uint32_t tmpreg;
 ...
 tmpreg = ECFGL_DIV << (4);
 (((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->FCLK) = SFR_Config((((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->FCLK), ~((uint32_t)0x07<<((4))), tmpreg);
}
# 261 "../src/kf32a1x6_ecfgl.c"
void ECFGL_Fliter_Clock_Select(uint32_t CLK)
{

 ((void)0);

 (((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->FCLK) = SFR_Config((((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->FCLK), ~((uint32_t)0x07<<((0))), CLK);
}
...
RetStatus ECFGLx_Clear_INT_Flag(uint32_t ECFGLx)
{
 ...
 tmask = 1 << ECFGLx;
 (((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->IC) = SFR_Config((((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->IC), ~tmask, tmask);
 while(((((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->IF) & tmask)&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
 (((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->IC) = SFR_Config((((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->IC), ~tmask, 0);
 if(wait_flag==(0xFFFF))
 {
  return FAILURE;
 }
...
FlagStatus ECFGLx_Get_INT_Flag(uint32_t ECFGLx)
{
 ...
 tmask = 1 << ECFGLx;
 return (((((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->IF) & tmask) >> ECFGLx);
}
# 318 "../src/kf32a1x6_ecfgl.c"
void ECFGLx_Rise_INT_Enable(uint32_t ECFGLx, FunctionalState NewState)
{
 uint32_t tmpreg;
 uint32_t tmask;
 ...
 tmask = 1 << ECFGLx;
 (((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->RFCTL) = SFR_Config((((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->RFCTL), ~tmask, tmpreg);
}
# 339 "../src/kf32a1x6_ecfgl.c"
void ECFGLx_Fall_INT_Enable(uint32_t ECFGLx, FunctionalState NewState)
{
 uint32_t tmpreg;
 uint32_t tmask;
 ...
 tmpreg = NewState << ECFGLx;
 tmask = 1 << ECFGLx;
 (((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->FFCTL) = SFR_Config((((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->FFCTL), ~tmask, tmpreg);
}
...
void ECFGLx_Trigger_ADC_Enable(FunctionalState NewState)
{
 ...
 tmpreg = NewState << (4);
 (((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->ADC) = SFR_Config((((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->ADC), ~((uint32_t)1<<((4))), tmpreg);
}
...
void ECFGLx_Trigger_ADC_Source_Select(uint32_t ECFGLx)
{
 ...
 (((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->ADC) = SFR_Config((((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->ADC), ~((uint32_t)0x0F<<((0))), ECFGLx);
}
...
FlagStatus ECFGLx_Get_ECFGLx_Output_Status(uint32_t ECFGLx)
{
 ...
 tmask = 1 << ECFGLx;
 return (((((ECFGL_SFRmap *) ((uint32_t)0x40002A80))->OUT) & tmask) >> ECFGLx);
}
