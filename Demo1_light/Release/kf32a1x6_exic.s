...
.Ltext0:
	...
	.stabn	162,0,0,0
	.stabn	162,0,0,0
	.stabs	"EXIC_InitTypeDef:t(1,1)=(1,2)=s60m_Module_Enable:(3,2),0,32;m_CS_Enable:(3,2),32,32;m_Data_Control_Sel:(4,6),64,32;m_Write_Enable:(3,2),96,32;m_Read_Enable:(3,2),128,32;m_DMA_Write_EN:(3,2),160,32;m_DMA_Read_EN:(3,2),192,32;m_WriteFnish_INT_EN:(3,2),224,32;m_ReadFnish_INT_EN:(3,2),256,32;m_WriteData_EN:(3,2),288,32;m_ReadData_EN:(3,2),320,32;m_Data_Direction_Sel:(4,6),352,32;m_Mode_Sel:(4,6),384,32;m_Source_Clock_Sel:(4,6),416,32;m_Pulse_Width_Sel:(4,6),448,32;;",128,0,67,0
	.stabn	162,0,0,0
	.section .text$EXIC_Reset
	.type	.text$EXIC_Reset$scode_local_1, @function
	.text$EXIC_Reset$scode_loacal_1:
	.align	1
	.stabs	"EXIC_Reset:F(0,15)",36,0,58,EXIC_Reset
	.export	EXIC_Reset
	.type	EXIC_Reset, @function
EXIC_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_exic.c",132,0,0,.Ltext1
.Ltext1:
	.stabn	68,0,59,.LM0-.LFBB1
.LM0:
.LFBB1:
	PUSH	{r6, r7, lr}
	.stabn	68,0,60,.LM1-.LFBB1
.LM1:
	MOV	r6,#1
	LSL	r6,#16
	MOV	r0,r6
...
.LM2:
	...
	MOV	r1,#0
	LJMP	r7
	.stabn	68,0,62,.LM3-.LFBB1
.LM3:
	MOV	r0,r6
	MOV	r1,#1
	LD	r5,#PCLK_CTL3_Peripheral_Clock_Enable
	LJMP	r5
	.stabn	68,0,63,.LM4-.LFBB1
.LM4:
	POP	{r6, r7}
	POP	lr
	JMP	lr
...
.Lscope1:
	...
	.text$EXIC_Configuration$scode_loacal_2:
	.align	1
	.stabs	"EXIC_Configuration:F(0,15)",36,0,69,EXIC_Configuration
	.stabs	"EXICInitStruct:P(0,16)=*(1,1)",64,0,69,0
	.export	EXIC_Configuration
	.type	EXIC_Configuration, @function
EXIC_Configuration:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_exic.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,70,.LM5-.LFBB2
.LM5:
.LFBB2:
	PUSH	{r6, r7}
	.stabn	68,0,118,.LM6-.LFBB2
.LM6:
	LD.w	r3,[r0+#13]
	.stabn	68,0,119,.LM7-.LFBB2
.LM7:
	LD.w	r2,[r0+#14]
	.stabn	68,0,120,.LM8-.LFBB2
.LM8:
	LD	r5,#1073752064
	LD.w	r6,[r5]
	.stabn	68,0,105,.LM9-.LFBB2
.LM9:
	LD.w	r4,[r0+#2]
	LD.w	r7,[r0]
	ORL	r1,r4,r7
	.stabn	68,0,106,.LM10-.LFBB2
.LM10:
	LD.w	r4,[r0+#11]
	ORL	r1,r1,r4
	.stabn	68,0,107,.LM11-.LFBB2
.LM11:
	LD.w	r7,[r0+#12]
	ORL	r1,r1,r7
...
.LM12:
	ORL	r1,r1,r3
	.stabn	68,0,109,.LM13-.LFBB2
.LM13:
	ORL	r1,r1,r2
	.stabn	68,0,106,.LM14-.LFBB2
.LM14:
	LD.w	r4,[r0+#1]
	ADD	r4,r4,r4
	.stabn	68,0,110,.LM15-.LFBB2
.LM15:
	ORL	r4,r1,r4
	.stabn	68,0,108,.LM16-.LFBB2
.LM16:
	LD.w	r1,[r0+#3]
	LSL	r1,#3
	.stabn	68,0,111,.LM17-.LFBB2
.LM17:
	ORL	r4,r4,r1
	.stabn	68,0,109,.LM18-.LFBB2
.LM18:
	LD.w	r1,[r0+#4]
	LSL	r1,#4
...
.LM20:
	LD.w	r1,[r0+#5]
	LSL	r1,#8
	.stabn	68,0,113,.LM21-.LFBB2
.LM21:
	ORL	r4,r4,r1
	.stabn	68,0,111,.LM22-.LFBB2
.LM22:
	LD.w	r1,[r0+#6]
	LSL	r1,#9
	.stabn	68,0,114,.LM23-.LFBB2
.LM23:
	ORL	r4,r4,r1
	.stabn	68,0,112,.LM24-.LFBB2
.LM24:
	LD.w	r1,[r0+#7]
	LSL	r1,#16
	.stabn	68,0,115,.LM25-.LFBB2
.LM25:
	ORL	r4,r4,r1
	.stabn	68,0,113,.LM26-.LFBB2
.LM26:
	LD.w	r1,[r0+#8]
	LSL	r1,#17
	.stabn	68,0,116,.LM27-.LFBB2
.LM27:
	ORL	r4,r4,r1
	.stabn	68,0,114,.LM28-.LFBB2
.LM28:
	LD.w	r1,[r0+#9]
	LSL	r1,#28
	.stabn	68,0,117,.LM29-.LFBB2
.LM29:
	ORL	r4,r4,r1
	.stabn	68,0,115,.LM30-.LFBB2
.LM30:
	LD.w	r1,[r0+#10]
	LSL	r1,#29
	.stabn	68,0,105,.LM31-.LFBB2
.LM31:
	ORL	r4,r4,r1
.LBB6:
.LBB7:
...
.LBE7:
.LBE6:
	.stabs	"../src/kf32a1x6_exic.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,120,.LM33-.LFBB2
.LM33:
	ST.w	[r5],r4
	.stabn	68,0,128,.LM34-.LFBB2
.LM34:
	LD.w	r1,[r5+#1]
	.stabn	68,0,126,.LM35-.LFBB2
.LM35:
	ORL	r3,r2,r3
.LBB8:
.LBB9:
	.stabs	"D:\\KungFu32\\workspace32\\Demo1_light\\inc/KF32A156.h",132,0,0,.Ltext5
.Ltext5:
	.stabn	68,0,14083,.LM36-.LFBB2
.LM36:
	MOV	r4,#243
	NOT	r4,r4
	ANL	r4,r1,r4
...
.LBE9:
.LBE8:
	.stabs	"../src/kf32a1x6_exic.c",132,0,0,.Ltext6
.Ltext6:
	.stabn	68,0,128,.LM37-.LFBB2
.LM37:
	ST.w	[r5+#1],r3
	.stabn	68,0,131,.LM38-.LFBB2
.LM38:
	POP	{r6, r7}
	JMP	lr
...
.Lscope2:
	...
	.text$EXIC_Struct_Init$scode_loacal_3:
	.align	1
	.stabs	"EXIC_Struct_Init:F(0,15)",36,0,137,EXIC_Struct_Init
	.stabs	"EXICInitStruct:P(0,16)",64,0,137,0
	.export	EXIC_Struct_Init
	.type	EXIC_Struct_Init, @function
EXIC_Struct_Init:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_exic.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,138,.LM39-.LFBB3
.LM39:
.LFBB3:
	.stabn	68,0,140,.LM40-.LFBB3
.LM40:
	MOV	r5,#0
	ST.w	[r0],r5
	.stabn	68,0,142,.LM41-.LFBB3
.LM41:
	ST.w	[r0+#1],r5
	.stabn	68,0,144,.LM42-.LFBB3
.LM42:
	ST.w	[r0+#2],r5
	.stabn	68,0,146,.LM43-.LFBB3
.LM43:
	ST.w	[r0+#3],r5
	.stabn	68,0,148,.LM44-.LFBB3
.LM44:
	ST.w	[r0+#4],r5
	.stabn	68,0,150,.LM45-.LFBB3
.LM45:
	ST.w	[r0+#5],r5
	.stabn	68,0,152,.LM46-.LFBB3
.LM46:
	ST.w	[r0+#6],r5
	.stabn	68,0,154,.LM47-.LFBB3
.LM47:
	ST.w	[r0+#7],r5
	.stabn	68,0,156,.LM48-.LFBB3
.LM48:
	ST.w	[r0+#8],r5
	.stabn	68,0,158,.LM49-.LFBB3
.LM49:
	ST.w	[r0+#9],r5
	.stabn	68,0,160,.LM50-.LFBB3
.LM50:
	ST.w	[r0+#10],r5
	.stabn	68,0,162,.LM51-.LFBB3
.LM51:
	MOV	r4,#1
	LSL	r4,#30
	ST.w	[r0+#11],r4
	.stabn	68,0,164,.LM52-.LFBB3
.LM52:
	MOV	r4,#1
	LSL	r4,#31
	ST.w	[r0+#12],r4
	.stabn	68,0,166,.LM53-.LFBB3
.LM53:
	ST.w	[r0+#13],r5
	.stabn	68,0,168,.LM54-.LFBB3
.LM54:
	MOV	r5,#64
	ST.w	[r0+#14],r5
	.stabn	68,0,169,.LM55-.LFBB3
.LM55:
	JMP	lr
...
.Lscope3:
	...
	.text$EXIC_Get_Write_Finish_INT_Flag$scode_loacal_4:
	.align	1
	.stabs	"EXIC_Get_Write_Finish_INT_Flag:F(3,4)",36,0,175,EXIC_Get_Write_Finish_INT_Flag
	.export	EXIC_Get_Write_Finish_INT_Flag
	.type	EXIC_Get_Write_Finish_INT_Flag, @function
EXIC_Get_Write_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_exic.c",132,0,0,.Ltext8
.Ltext8:
	.stabn	68,0,176,.LM56-.LFBB4
.LM56:
.LFBB4:
	.stabn	68,0,178,.LM57-.LFBB4
.LM57:
	LD	r5,#1073752064
	LD.w	r0,[r5+#2]
	.stabn	68,0,188,.LM58-.LFBB4
.LM58:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope4:
	...
	.text$EXIC_Clear_Write_Finish_INT_Flag$scode_loacal_5:
	.align	1
	.stabs	"EXIC_Clear_Write_Finish_INT_Flag:F(3,7)",36,0,194,EXIC_Clear_Write_Finish_INT_Flag
	.export	EXIC_Clear_Write_Finish_INT_Flag
	.type	EXIC_Clear_Write_Finish_INT_Flag, @function
EXIC_Clear_Write_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_exic.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,195,.LM59-.LFBB5
.LM59:
.LFBB5:
	.stabn	68,0,198,.LM60-.LFBB5
.LM60:
	LD	r5,#1073752064
	LD.w	r4,[r5+#2]
	MOV	r2,#1
...
.L7:
	...
	JZ	.L13
.L8:
	.stabn	68,0,200,.LM61-.LFBB5
.LM61:
	ADD	r4,r4,#1
	.stabn	68,0,201,.LM62-.LFBB5
.LM62:
	LD.w	r3,[r5+#2]
	CLR	r3,#0
	ST.w	[r5+#2],r3
	.stabn	68,0,198,.LM63-.LFBB5
.LM63:
	LD.w	r3,[r5+#2]
	ANL	r3,r3,r2
	JNZ	.L7
	...
	MOV	r5,#31
	LSR	r0,r4,r5
	.stabn	68,0,208,.LM64-.LFBB5
.LM64:
	JMP	lr
.L13:
	.stabn	68,0,205,.LM65-.LFBB5
.LM65:
	MOV	r0,#0
	.stabn	68,0,208,.LM66-.LFBB5
.LM66:
	JMP	lr
.L10:
	.stabn	68,0,198,.LM67-.LFBB5
.LM67:
	MOV	r0,r2
	.stabn	68,0,208,.LM68-.LFBB5
.LM68:
	JMP	lr
	.size	EXIC_Clear_Write_Finish_INT_Flag, .-EXIC_Clear_Write_Finish_INT_Flag
	.stabs	"wait_flag:r(4,6)",64,0,196,4
...
.Lscope5:
	...
	.text$EXIC_Get_Read_Finish_INT_Flag$scode_loacal_6:
	.align	1
	.stabs	"EXIC_Get_Read_Finish_INT_Flag:F(3,4)",36,0,214,EXIC_Get_Read_Finish_INT_Flag
	.export	EXIC_Get_Read_Finish_INT_Flag
	.type	EXIC_Get_Read_Finish_INT_Flag, @function
EXIC_Get_Read_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_exic.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,215,.LM69-.LFBB6
.LM69:
.LFBB6:
	.stabn	68,0,217,.LM70-.LFBB6
.LM70:
	LD	r5,#1073752064
	LD.w	r0,[r5+#2]
	LSR	r0,#1
	.stabn	68,0,227,.LM71-.LFBB6
.LM71:
	MOV	r5,#1
	ANL	r0,r0,r5
	JMP	lr
...
.Lscope6:
	...
	.text$EXIC_Clear_Read_Finish_INT_Flag$scode_loacal_7:
	.align	1
	.stabs	"EXIC_Clear_Read_Finish_INT_Flag:F(3,7)",36,0,233,EXIC_Clear_Read_Finish_INT_Flag
	.export	EXIC_Clear_Read_Finish_INT_Flag
	.type	EXIC_Clear_Read_Finish_INT_Flag, @function
EXIC_Clear_Read_Finish_INT_Flag:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_exic.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,234,.LM72-.LFBB7
.LM72:
.LFBB7:
	.stabn	68,0,237,.LM73-.LFBB7
.LM73:
	LD	r5,#1073752064
	LD.w	r4,[r5+#2]
	MOV	r2,#2
...
.L17:
	...
	JZ	.L22
.L18:
	.stabn	68,0,239,.LM74-.LFBB7
.LM74:
	ADD	r4,r4,#1
	.stabn	68,0,240,.LM75-.LFBB7
.LM75:
	LD.w	r3,[r5+#2]
	CLR	r3,#1
	ST.w	[r5+#2],r3
	.stabn	68,0,237,.LM76-.LFBB7
.LM76:
	LD.w	r3,[r5+#2]
	ANL	r3,r3,r2
	LSR	r3,#1
	...
	MOV	r5,#31
	LSR	r0,r4,r5
	.stabn	68,0,247,.LM77-.LFBB7
.LM77:
	JMP	lr
.L22:
	.stabn	68,0,244,.LM78-.LFBB7
.LM78:
	MOV	r0,#0
	.stabn	68,0,247,.LM79-.LFBB7
.LM79:
	JMP	lr
.L20:
	.stabn	68,0,237,.LM80-.LFBB7
.LM80:
	MOV	r0,#1
	.stabn	68,0,247,.LM81-.LFBB7
.LM81:
	JMP	lr
	.size	EXIC_Clear_Read_Finish_INT_Flag, .-EXIC_Clear_Read_Finish_INT_Flag
	.stabs	"wait_flag:r(4,6)",64,0,235,4
...
.Lscope7:
	...
	.text$EXIC_Write_Buff$scode_loacal_8:
	.align	1
	.stabs	"EXIC_Write_Buff:F(0,15)",36,0,253,EXIC_Write_Buff
	.stabs	"DATA:P(4,6)",64,0,253,0
	.export	EXIC_Write_Buff
	.type	EXIC_Write_Buff, @function
EXIC_Write_Buff:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_exic.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,254,.LM82-.LFBB8
.LM82:
.LFBB8:
	.stabn	68,0,255,.LM83-.LFBB8
.LM83:
	LD	r5,#1073752064
	ST.w	[r5+#4],r0
	.stabn	68,0,256,.LM84-.LFBB8
.LM84:
	JMP	lr
...
.Lscope8:
	...
	.text$EXIC_Read_Buff$scode_loacal_9:
	.align	1
	.stabs	"EXIC_Read_Buff:F(4,6)",36,0,263,EXIC_Read_Buff
	.export	EXIC_Read_Buff
	.type	EXIC_Read_Buff, @function
EXIC_Read_Buff:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_exic.c",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,264,.LM85-.LFBB9
.LM85:
.LFBB9:
	.stabn	68,0,266,.LM86-.LFBB9
.LM86:
	LD	r5,#1073752064
	LD.w	r0,[r5+#5]
	.stabn	68,0,268,.LM87-.LFBB9
.LM87:
	JMP	lr
