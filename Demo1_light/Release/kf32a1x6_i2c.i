...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_i2c.h" 2
...
# 41 "../src/kf32a1x6_i2c.c" 2
# 64 "../src/kf32a1x6_i2c.c"
void I2C_Reset (I2C_SFRmap* I2Cx)
{
    ...
    else if (I2Cx == ((I2C_SFRmap *) ((uint32_t)0x40000D80)))
    {
    ...
    else if (I2Cx == ((I2C_SFRmap *) ((uint32_t)0x40000E00)))
    {
    ...
    else if (I2Cx == ((I2C_SFRmap *) ((uint32_t)0x40002380)))
    {
...
# 316 "../src/kf32a1x6_i2c.c"
void I2C_Ack_DATA_Config (I2C_SFRmap* I2Cx, uint32_t NewState)
{
...
void I2C_CLOCK_Div_Config(I2C_SFRmap* I2Cx, uint32_t DIV)
{
    ...
    tmpreg = DIV << (18);
    I2Cx->CTLR = SFR_Config(I2Cx->CTLR, ~((uint32_t)3<<((18))), tmpreg);
}
# 742 "../src/kf32a1x6_i2c.c"
void I2C_Keep_Data_Time_Config(I2C_SFRmap* I2Cx, uint32_t Time)
{
    uint32_t tmpreg;
 ...
 ((void)0);
    ...
    tmpreg = Time << (2);
    I2Cx->CTLR = SFR_Config(I2Cx->CTLR, ~((uint32_t)0x0F<<((2))), tmpreg);
}
# 768 "../src/kf32a1x6_i2c.c"
void I2C_Start_INT_Enable (I2C_SFRmap* I2Cx,FunctionalState NewState)
{
...
RetStatus I2C_Clear_Start_Flag (I2C_SFRmap* I2Cx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((((I2Cx->SR) & ((uint32_t)1<<((0))))>>(0))&& (wait_flag != (0xFFFF)))
    {
...
RetStatus I2C_Clear_Stop_Flag (I2C_SFRmap* I2Cx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((((I2Cx->SR) & ((uint32_t)1<<((1))))>>(1))&& (wait_flag != (0xFFFF)))
    {
...
RetStatus I2C_Clear_Ack_Fail_Flag (I2C_SFRmap* I2Cx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((((I2Cx->SR) & ((uint32_t)1<<((5))))>>(5))&& (wait_flag != (0xFFFF)))
    {
...
RetStatus I2C_Clear_Arbitration_Lost_Flag (I2C_SFRmap* I2Cx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((((I2Cx->SR) & ((uint32_t)1<<((6))))>>(6))&& (wait_flag != (0xFFFF)))
    {
...
RetStatus I2C_Clear_SMBus_Alert_Flag (I2C_SFRmap* I2Cx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((((I2Cx->SR) & ((uint32_t)1<<((8))))>>(8))&& (wait_flag != (0xFFFF)))
    {
...
RetStatus I2C_Clear_SMBus_Host_Header_Flag (I2C_SFRmap* I2Cx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((((I2Cx->SR) & ((uint32_t)1<<((9))))>>(9))&& (wait_flag != (0xFFFF)))
    {
...
RetStatus I2C_Clear_SMBus_Device_Default_Flag (I2C_SFRmap* I2Cx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((((I2Cx->SR) & ((uint32_t)1<<((10))))>>(10))&& (wait_flag != (0xFFFF)))
    {
...
RetStatus I2C_Clear_INTERRUPT_Flag (I2C_SFRmap* I2Cx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((((I2Cx->SR) & ((uint32_t)1<<((11))))>>(11))&& (wait_flag != (0xFFFF)))
    {
