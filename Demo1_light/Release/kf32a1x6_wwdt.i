...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_wwdt.h" 2
...
# 36 "../src/kf32a1x6_wwdt.c" 2
# 46 "../src/kf32a1x6_wwdt.c"
void WWDT_Reset (void)
{
...
# 115 "../src/kf32a1x6_wwdt.c"
void WWDT_Work_CLK_Selest(uint32_t Source)
{

 ((void)0);

 (((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL1) = SFR_Config((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL1), ~((uint32_t)0x03<<((0))), Source);
}
...
RetStatus WWDT_Clear_INT_Flag (void)
{
 uint32_t wait_flag=0x0000;
    ...
    while(((((WWDT_SFRmap *) ((uint32_t)0x40001280))->CTL) & ((uint32_t)1<<((2))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
