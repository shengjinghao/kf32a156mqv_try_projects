...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_fdc.h" 2
...
# 33 "../src/kf32a1x6_fdc.c" 2
# 44 "../src/kf32a1x6_fdc.c"
void FDC_Reset(FDC_SFRmap* FDCx)
{

 ((void)0);

 if(FDCx == ((FDC_SFRmap *) ((uint32_t) 0x40002B80)))
 {
  RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((22))), TRUE);
  RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((22))), FALSE);
        PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((22))), TRUE);
 }
 else if(FDCx == ((FDC_SFRmap *) ((uint32_t) 0x40002C00)))
 {
  RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((23))), TRUE);
  RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((23))), FALSE);
        PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((23))), TRUE);
 }
 else if(FDCx == ((FDC_SFRmap *) ((uint32_t) 0x40002C80)))
 {
  RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((24))), TRUE);
  RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((24))), FALSE);
        PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((24))), TRUE);
 }
 else
 {
  ;
...
void FDC_TRGI_Count_Reset_Enable(FDC_SFRmap* FDCx, FunctionalState NewState)
{
 ...
 tmpreg = NewState << (26);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((26))), tmpreg);
}
# 100 "../src/kf32a1x6_fdc.c"
void FDC_Work_Clk_Select(FDC_SFRmap* FDCx, uint32_t CLK)
{
 uint32_t tmpreg;
 ...
 tmpreg = CLK << (24);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)0x03<<((24))), tmpreg);
}
# 119 "../src/kf32a1x6_fdc.c"
RetStatus FDC_Clear_MDLIF_Flag(FDC_SFRmap* FDCx, FunctionalState NewState)
{
 uint32_t tmpreg;
 ...
 tmpreg = NewState << (23);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((23))), tmpreg);
 while((!(FDCx->CTL & ((uint32_t)1<<((23)))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((23))), 0);
 if(wait_flag==(0xFFFF))
 {
  return FAILURE;
 }
...
void FDC_Cycle_Scan_Enable(FDC_SFRmap* FDCx, FunctionalState NewState)
{
 ...
 tmpreg = NewState << (22);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((22))), tmpreg);
}
# 168 "../src/kf32a1x6_fdc.c"
void FDC_Work_Mode_Select(FDC_SFRmap* FDCx, uint32_t MODE)
{
 uint32_t tmpreg;
 ...
 tmpreg = MODE << (21);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((21))), tmpreg);
}
# 189 "../src/kf32a1x6_fdc.c"
void FDC_Updata_Mode_Select(FDC_SFRmap* FDCx, uint32_t MODE)
{
 uint32_t tmpreg;
 ...
 tmpreg = MODE << (19);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)0x03<<((19))), tmpreg);
}
# 208 "../src/kf32a1x6_fdc.c"
void FDC_Sequence_Error_INT_Enable(FDC_SFRmap* FDCx, FunctionalState NewState)
{
 uint32_t tmpreg;
 ...
 tmpreg = NewState << (18);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((18))), tmpreg);
}
...
void FDC_Software_Triggle_Enable(FDC_SFRmap* FDCx)
{
 ...
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((17))), ((uint32_t)1<<((17))));
}
# 240 "../src/kf32a1x6_fdc.c"
void FDC_MDL_INT_DMA_Enable(FDC_SFRmap* FDCx, FunctionalState NewState)
{
 uint32_t tmpreg;
 ...
 tmpreg = NewState << (16);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((16))), tmpreg);
}
# 265 "../src/kf32a1x6_fdc.c"
void FDC_Prescaler_Select(FDC_SFRmap* FDCx, uint32_t Select)
{
 uint32_t tmpreg;
 ...
 tmpreg = Select << (13);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)0x07<<((13))), tmpreg);
}
...
void FDC_Scaler_Factor(FDC_SFRmap* FDCx, uint32_t Value)
{
 ...
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)0x3F<<((7))), Value << (7));
}
...
void FDC_Triggle_Input_Select(FDC_SFRmap* FDCx, uint32_t Select)
{
 ...
 tmpreg = Select << (6);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((6))), tmpreg);
}
...
void FDC_MDL_INT_Enable(FDC_SFRmap* FDCx, uint32_t Select)
{
 ...
 tmpreg = Select << (5);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((5))), tmpreg);
}
...
FlagStatus FDC_Get_MDL_INT_Flag(FDC_SFRmap* FDCx)
{
 ...
 return ((FDCx->CTL & ((uint32_t)1<<((4)))) >> (4));
}
...
void FDC_Single_Mode_Enable(FDC_SFRmap* FDCx, FunctionalState NewState)
{
 ...
 tmpreg = NewState << (3);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((3))), tmpreg);
}
...
void FDC_Ldok_Write1(FDC_SFRmap* FDCx)
{
 ...
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((2))), ((uint32_t)1<<((2))));
}
...
void FDC_Pulse_Output_Enable(FDC_SFRmap* FDCx, FunctionalState NewState)
{
 ...
 tmpreg = NewState << (1);
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((1))), tmpreg);
}
...
void FDC_Enable(FDC_SFRmap* FDCx, FunctionalState NewState)
{
 ...
 FDCx->CTL = SFR_Config(FDCx->CTL, ~((uint32_t)1<<((0))), ((uint32_t)1<<((0))));
}
# 409 "../src/kf32a1x6_fdc.c"
void FDC_Set_Count_Cycle(FDC_SFRmap* FDCx, uint32_t Value)
{
