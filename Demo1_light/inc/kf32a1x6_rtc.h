 ...
 ******************************************************************************
 *  $File Name$       : kf32a1x6_rtc.h                                	      *
 *  $Author$          : ChipON AE/FAE Group                                   *
 *  $Data$            : 2021-07-08                                            *
 *  $AutoSAR Version  : V2.0                                          	      *
 *  $Description$     : This file contains the headers of the RTC			  *
 *						peripherals.										  *
 ******************************************************************************
 ...
 *                                                                            *
 *****************************************************************************/
#ifndef KF32A1x6_RTC_H_
#define KF32A1x6_RTC_H_
...
/**
  * RTC时钟源
  */
#define RTC_WORK_CLK_NO_CLK               ((uint32_t)0<<RTC_CR_RTCCLKS0_POS)
#define RTC_WORK_CLK_EXTLF                ((uint32_t)1<<RTC_CR_RTCCLKS0_POS)
#define RTC_WORK_CLK_INTLF                ((uint32_t)2<<RTC_CR_RTCCLKS0_POS)
#define RTC_WORK_CLK_EXTHF_DIV_128        ((uint32_t)3<<RTC_CR_RTCCLKS0_POS)
#define CHECK_RTC_WORK_CLK(SEL)           (((SEL) == RTC_WORK_CLK_NO_CLK) \
                                       || ((SEL) == RTC_WORK_CLK_EXTLF) \
                                       || ((SEL) == RTC_WORK_CLK_INTLF) \
                                       || ((SEL) == RTC_WORK_CLK_EXTHF_DIV_128))
