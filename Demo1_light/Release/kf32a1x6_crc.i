...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_crc.h" 2
...
# 33 "../src/kf32a1x6_crc.c" 2
# 53 "../src/kf32a1x6_crc.c"
void CRC_Reset (void)
{
...
# 117 "../src/kf32a1x6_crc.c"
uint32_t CRC_Get_Register_Value(uint32_t CRC_Register)
{

 ((void)0);

 return (*((uint32_t *)(((uint32_t)0x40002680)+4*CRC_Register)));
}
# 134 "../src/kf32a1x6_crc.c"
void CRC_Register_Value_Config(uint32_t CRC_Register ,uint32_t Value)
{

 ((void)0);

 *((uint32_t *)(((uint32_t)0x40002680)+4*CRC_Register)) = Value;
}
...
void CRC_Result_Reverse_Enable(FunctionalState NewState)
{
 ...
 (((CRC_SFRmap *) ((uint32_t)0x40002680))->CTL) = SFR_Config((((CRC_SFRmap *) ((uint32_t)0x40002680))->CTL), ~((uint32_t)1<<((7))), NewState<<(7));
}
...
void CRC_Input_Data_Reverse_Enable(FunctionalState NewState)
{
 ...
 (((CRC_SFRmap *) ((uint32_t)0x40002680))->CTL) = SFR_Config((((CRC_SFRmap *) ((uint32_t)0x40002680))->CTL), ~((uint32_t)1<<((5))), NewState<<(5));
}
# 178 "../src/kf32a1x6_crc.c"
void CRC_Input_Data_Format_Config(uint32_t Select)
{

 ((void)0);

 (((CRC_SFRmap *) ((uint32_t)0x40002680))->CTL) = SFR_Config((((CRC_SFRmap *) ((uint32_t)0x40002680))->CTL), ~((uint32_t)0x3<<((2))), Select);
}
...
void CRC_Calculation_Unit_Reset_Enable(FunctionalState NewState)
{
 ...
 (((CRC_SFRmap *) ((uint32_t)0x40002680))->CTL) = SFR_Config((((CRC_SFRmap *) ((uint32_t)0x40002680))->CTL), ~((uint32_t)1<<((0))), NewState<<(0));
}
# 209 "../src/kf32a1x6_crc.c"
void CRC_INPUT_DATA (uint32_t DATA)
{
