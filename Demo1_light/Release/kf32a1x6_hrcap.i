# 1 "../src/kf32a1x6_hrcap.c"
# 1 "D:\\KungFu32\\workspace32\\Demo1_light\\Release//"
# 1 "<command-line>"
# 1 "../src/kf32a1x6_hrcap.c"
# 31 "../src/kf32a1x6_hrcap.c"
# 1 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_hrcap.h" 1
# 29 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_hrcap.h"
...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_hrcap.h" 2
...
# 34 "../src/kf32a1x6_hrcap.c" 2
# 44 "../src/kf32a1x6_hrcap.c"
void HRCAP_Reset (HRCAP_SFRmap* HRCAPx)
{

 ((void)0);

 if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002400)))
 {

  RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((8))), TRUE);
  RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((8))), FALSE);

  PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((8))), TRUE);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002480)))
 {

  RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((9))), TRUE);
  RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((9))), FALSE);

  PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((9))), TRUE);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002500)))
 {

  RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((10))), TRUE);
  RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((10))), FALSE);

  PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((10))), TRUE);
 }
 else
 {
  ;
...
void HRCAP_CLK_Select(HRCAP_SFRmap* HRCAPx, uint32_t CLK)
{
 ...
 if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002400)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002400))->CTL) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002400))->CTL), ~((uint32_t)0x03<<((5))), tmpreg);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002480)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002480))->CTL) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002480))->CTL), ~((uint32_t)0x03<<((5))), tmpreg);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002500)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002500))->CTL) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002500))->CTL), ~((uint32_t)0x03<<((5))), tmpreg);
 }
 else
 {
  ;
...
void HRCAP_Software_Reset_Enable(HRCAP_SFRmap* HRCAPx, FunctionalState NewState)
{
 ...
 if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002400)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002400))->CTL) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002400))->CTL), ~((uint32_t)1<<((4))), tmpreg);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002480)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002480))->CTL) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002480))->CTL), ~((uint32_t)1<<((4))), tmpreg);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002500)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002500))->CTL) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002500))->CTL), ~((uint32_t)1<<((4))), tmpreg);
 }
 else
 {
  ;
...
void HRCAP_INT_Enable(HRCAP_SFRmap* HRCAPx,uint32_t Select, FunctionalState NewState)
{
 ...
 tmpreg = NewState << ((1) + Select);
 tmask = 1 << ((1) + Select);
 if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002400)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002400))->CTL) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002400))->CTL), ~tmask, tmpreg);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002480)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002480))->CTL) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002480))->CTL), ~tmask, tmpreg);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002500)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002500))->CTL) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002500))->CTL), ~tmask, tmpreg);
 }
 else
 {
  ;
...
void HRCAP_Cap_Input_Select(HRCAP_SFRmap* HRCAPx, uint32_t Select)
{
 ...
 if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002400)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002400))->CTL) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002400))->CTL), ~((uint32_t)1<<((0))), Select);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002480)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002480))->CTL) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002480))->CTL), ~((uint32_t)1<<((0))), Select);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002500)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002500))->CTL) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002500))->CTL), ~((uint32_t)1<<((0))), Select);
 }
 else
 {
  ;
...
uint16_t HRCAP_Read_Latch_Count_Value(HRCAP_SFRmap* HRCAPx)
{
 ...
 if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002400)))
 {
  Value = ((((HRCAP_SFRmap *) ((uint32_t)0x40002400))->COUNTER) & ((uint32_t)0xFFFF<<((16)))) >> (16);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002480)))
 {
  Value = ((((HRCAP_SFRmap *) ((uint32_t)0x40002480))->COUNTER) & ((uint32_t)0xFFFF<<((16)))) >> (16);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002500)))
 {
  Value = ((((HRCAP_SFRmap *) ((uint32_t)0x40002500))->COUNTER) & ((uint32_t)0xFFFF<<((16)))) >> (16);
 }
 else
 {
  ;
...
uint16_t HRCAP_Read_Count_Value(HRCAP_SFRmap* HRCAPx)
{
 ...
 if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002400)))
 {
  Value = (((HRCAP_SFRmap *) ((uint32_t)0x40002400))->COUNTER) & ((uint32_t)0xFFFF<<((0)));
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002480)))
 {
  Value = (((HRCAP_SFRmap *) ((uint32_t)0x40002480))->COUNTER) & ((uint32_t)0xFFFF<<((0)));
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002500)))
 {
  Value = (((HRCAP_SFRmap *) ((uint32_t)0x40002500))->COUNTER) & ((uint32_t)0xFFFF<<((0)));
 }
 else
 {
  ;
...
uint16_t HRCAP_Read_Rise_Integer_Value(HRCAP_SFRmap* HRCAPx, uint32_t HRCAP_REG)
{
 ...
 Value = HRCAPx->RISE[HRCAP_REG] & ((uint32_t)0xFFFF<<((0)));

 return Value;
}
# 311 "../src/kf32a1x6_hrcap.c"
uint16_t HRCAP_Read_Fall_Integer_Value(HRCAP_SFRmap* HRCAPx, uint32_t HRCAP_REG)
{
 uint32_t Value = 0;
 ...
 Value = HRCAPx->FALL[HRCAP_REG] & ((uint32_t)0xFFFF<<((0)));

 return Value;
}
# 331 "../src/kf32a1x6_hrcap.c"
uint16_t HRCAP_Read_Rise_Decimal_Value(HRCAP_SFRmap* HRCAPx, uint32_t HRCAP_REG)
{
 uint32_t Value = 0;
 ...
 Value = HRCAPx->HRRISE[HRCAP_REG] & ((uint32_t)0xFFFF<<((0)));

 return Value;
}
# 351 "../src/kf32a1x6_hrcap.c"
uint16_t HRCAP_Read_Fall_Decimal_Value(HRCAP_SFRmap* HRCAPx, uint32_t HRCAP_REG)
{
 uint32_t Value = 0;
 ...
 Value = HRCAPx->HRFALL[HRCAP_REG] & ((uint32_t)0xFFFF<<((0)));

 return Value;
}
# 374 "../src/kf32a1x6_hrcap.c"
FlagStatus HRCAP_Get_INT_Flag(HRCAP_SFRmap* HRCAPx, uint32_t Select)
{
 uint32_t Value = 0;
 uint32_t tmask;
 ...
 if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002400)))
 {
  Value = ((((HRCAP_SFRmap *) ((uint32_t)0x40002400))->SR) & tmask) >> Select;
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002480)))
 {
  Value = ((((HRCAP_SFRmap *) ((uint32_t)0x40002480))->SR) & tmask) >> Select;
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002500)))
 {
  Value = ((((HRCAP_SFRmap *) ((uint32_t)0x40002500))->SR) & tmask) >> Select;
 }
 else
 {
  ;
...
RetStatus HRCAP_Clear_INT_Flag(HRCAP_SFRmap* HRCAPx, uint32_t Select)
{
 ...
 while((HRCAPx->SR & tmask)&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
void HRCAP_INT_Mandatory_Enable(HRCAP_SFRmap* HRCAPx, uint32_t Select, FunctionalState NewState)
{
 ...
 tmpreg = NewState << (Select + (1));
 tmask = 1 << (Select + (1));

 if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002400)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002400))->IFRC) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002400))->IFRC), ~tmask, tmpreg);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002480)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002480))->IFRC) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002480))->IFRC), ~tmask, tmpreg);
 }
 else if(HRCAPx == ((HRCAP_SFRmap *) ((uint32_t)0x40002500)))
 {
  (((HRCAP_SFRmap *) ((uint32_t)0x40002500))->IFRC) = SFR_Config((((HRCAP_SFRmap *) ((uint32_t)0x40002500))->IFRC), ~tmask, tmpreg);
 }
 else
 {
  ;
