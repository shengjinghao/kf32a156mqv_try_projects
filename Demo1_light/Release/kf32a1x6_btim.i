...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_btim.h" 2
...
# 38 "../src/kf32a1x6_btim.c" 2
# 65 "../src/kf32a1x6_btim.c"
void TIM_Reset (void* TIMx)
{
    ...
    else if ((uint32_t)TIMx == ((uint32_t)0x40000100))
    {
    ...
    else if ((uint32_t)TIMx == ((uint32_t)0x40000180))
    {
    ...
    else if ((uint32_t)TIMx == ((uint32_t)0x40000200))
    {
    ...
    else if ((uint32_t)TIMx == ((uint32_t)0x40000280))
    {
    ...
    else if ((uint32_t)TIMx == ((uint32_t)0x40000300))
    {
    ...
    else if ((uint32_t)TIMx == ((uint32_t)0x40001800))
    {
    ...
    else if ((uint32_t)TIMx == ((uint32_t)0x40001A80))
    {
    ...
    else if ((uint32_t)TIMx == ((uint32_t)0x40001B00))
    {
    ...
    else if ((uint32_t)TIMx == ((uint32_t)0x40001C00))
    {
...
void BTIM_Reset (BTIM_SFRmap* BTIMx)
{
    ...
    if (BTIMx == ((BTIM_SFRmap *)((uint32_t)0x40001800)))
    {
        RST_CTL2_Peripheral_Reset_Enable(((uint32_t)1<<((16))), TRUE);
        RST_CTL2_Peripheral_Reset_Enable(((uint32_t)1<<((16))), FALSE);
        PCLK_CTL2_Peripheral_Clock_Enable(((uint32_t)1<<((16))), TRUE);
...
RetStatus BTIM_Clear_Overflow_INT_Flag (BTIM_SFRmap* BTIMx)
{
 uint32_t wait_flag = 0x0000;
    ...
    while(((BTIMx->SR & ((uint32_t)1<<((2))))>>(2))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus BTIM_Clear_Trigger_INT_Flag (BTIM_SFRmap* BTIMx)
{
 uint32_t wait_flag = 0x0000;
    ...
    while(((BTIMx->SR & ((uint32_t)1<<((1))))>>(1))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus BTIM_Clear_Updata_INT_Flag (BTIM_SFRmap* BTIMx)
{
 uint32_t wait_flag = 0x0000;
    ...
    while(((BTIMx->SR & ((uint32_t)1<<((0))))>>(0))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
