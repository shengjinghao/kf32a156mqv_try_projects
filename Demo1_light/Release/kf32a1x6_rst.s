	...
	.stabs	"../src/kf32a1x6_rst.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabs	"D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_rst.h",130,0,0,0
	...
	.text$RST_CTL0_Peripheral_Reset_Enable$scode_loacal_1:
	.align	1
	.stabs	"RST_CTL0_Peripheral_Reset_Enable:F(0,15)",36,0,55,RST_CTL0_Peripheral_Reset_Enable
	.stabs	"RST_CTL0_bit:P(4,6)",64,0,55,0
	.stabs	"NewState:P(3,2)",64,0,55,1
	.export	RST_CTL0_Peripheral_Reset_Enable
	.type	RST_CTL0_Peripheral_Reset_Enable, @function
RST_CTL0_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_rst.c",132,0,0,.Ltext1
.Ltext1:
	.stabn	68,0,56,.LM0-.LFBB1
.LM0:
.LFBB1:
...
.LM3:
	...
	ANL	r0,r0,r4
	ST.w	[r5],r0
	.stabn	68,0,69,.LM4-.LFBB1
.LM4:
	JMP	lr
.L5:
	.stabn	68,0,63,.LM5-.LFBB1
.LM5:
	ORL	r0,r0,r4
	ST.w	[r5],r0
...
.Lscope1:
	...
	.text$RST_CTL1_Peripheral_Reset_Enable$scode_loacal_2:
	.align	1
	.stabs	"RST_CTL1_Peripheral_Reset_Enable:F(0,15)",36,0,100,RST_CTL1_Peripheral_Reset_Enable
	.stabs	"RST_CTL1_bit:P(4,6)",64,0,100,0
	.stabs	"NewState:P(3,2)",64,0,100,1
	.export	RST_CTL1_Peripheral_Reset_Enable
	.type	RST_CTL1_Peripheral_Reset_Enable, @function
RST_CTL1_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_rst.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,101,.LM7-.LFBB2
.LM7:
.LFBB2:
	.stabn	68,0,108,.LM8-.LFBB2
.LM8:
	LD	r5,#1073747200
	LD.w	r4,[r5+#1]
	.stabn	68,0,106,.LM9-.LFBB2
.LM9:
	CMP	r1,#0
	JNZ	.L9
	.stabn	68,0,112,.LM10-.LFBB2
.LM10:
	NOT	r0,r0
	ANL	r0,r0,r4
	ST.w	[r5+#1],r0
	.stabn	68,0,114,.LM11-.LFBB2
.LM11:
	JMP	lr
.L9:
...
.Lscope2:
	...
	.text$RST_CTL2_Peripheral_Reset_Enable$scode_loacal_3:
	.align	1
	.stabs	"RST_CTL2_Peripheral_Reset_Enable:F(0,15)",36,0,139,RST_CTL2_Peripheral_Reset_Enable
	.stabs	"RST_CTL2_bit:P(4,6)",64,0,139,0
	.stabs	"NewState:P(3,2)",64,0,139,1
	.export	RST_CTL2_Peripheral_Reset_Enable
	.type	RST_CTL2_Peripheral_Reset_Enable, @function
RST_CTL2_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_rst.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,140,.LM14-.LFBB3
.LM14:
.LFBB3:
	.stabn	68,0,147,.LM15-.LFBB3
.LM15:
	LD	r5,#1073747200
	LD.w	r4,[r5+#2]
	.stabn	68,0,145,.LM16-.LFBB3
.LM16:
	CMP	r1,#0
	JNZ	.L13
	.stabn	68,0,151,.LM17-.LFBB3
.LM17:
	NOT	r0,r0
	ANL	r0,r0,r4
	ST.w	[r5+#2],r0
	.stabn	68,0,153,.LM18-.LFBB3
.LM18:
	JMP	lr
.L13:
	.stabn	68,0,147,.LM19-.LFBB3
.LM19:
	ORL	r0,r0,r4
	ST.w	[r5+#2],r0
	.stabn	68,0,153,.LM20-.LFBB3
.LM20:
	JMP	lr
...
.Lscope3:
	...
	.text$RST_CTL3_Peripheral_Reset_Enable$scode_loacal_4:
	.align	1
	.stabs	"RST_CTL3_Peripheral_Reset_Enable:F(0,15)",36,0,184,RST_CTL3_Peripheral_Reset_Enable
	.stabs	"RST_CTL3_bit:P(4,6)",64,0,184,0
	.stabs	"NewState:P(3,2)",64,0,184,1
	.export	RST_CTL3_Peripheral_Reset_Enable
	.type	RST_CTL3_Peripheral_Reset_Enable, @function
RST_CTL3_Peripheral_Reset_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_rst.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,185,.LM21-.LFBB4
.LM21:
.LFBB4:
	.stabn	68,0,192,.LM22-.LFBB4
.LM22:
	LD	r5,#1073747200
	LD.w	r4,[r5+#3]
	.stabn	68,0,190,.LM23-.LFBB4
.LM23:
	CMP	r1,#0
	JNZ	.L17
	.stabn	68,0,196,.LM24-.LFBB4
.LM24:
	NOT	r0,r0
	ANL	r0,r0,r4
	ST.w	[r5+#3],r0
	.stabn	68,0,198,.LM25-.LFBB4
.LM25:
	JMP	lr
.L17:
	.stabn	68,0,192,.LM26-.LFBB4
.LM26:
	ORL	r0,r0,r4
	ST.w	[r5+#3],r0
	.stabn	68,0,198,.LM27-.LFBB4
.LM27:
	JMP	lr
