...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_cmp.h" 2
...
# 31 "../src/kf32a1x6_cmp.c" 2
# 88 "../src/kf32a1x6_cmp.c"
void CMP_Reset (void)
{
...
void CMP_Configuration (uint32_t CMPx_ADDR, CMP_InitTypeDef* CMPInitStruct)
{
    ...
    if(CMPx_ADDR==((uint32_t)0x40000800))
    {
     ((void)0);
     ((void)0);
        ((void)0);
...
# 132 "../src/kf32a1x6_cmp.c"
    ...
    (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0), ~(((uint32_t)0x0F<<((28))) | ((uint32_t)0x0F<<((24))) | ((uint32_t)1<<((19))) | ((uint32_t)1<<((18))) | ((uint32_t)0x3<<((16))) | ((uint32_t)0xFF<<((8))) | ((uint32_t)0x7<<((4))) | ((uint32_t)1<<((3))) | ((uint32_t)1<<((2))) | ((uint32_t)1<<((1)))), tmpreg);

     if ((CMPInitStruct->m_CmpEnable) != FALSE)
     {

         __asm volatile("SET [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((0)));
     }
     else
     {

         __asm volatile("CLR [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((0)));
     }
    }
    else if(CMPx_ADDR==((uint32_t)0x40000804))
    {
     ((void)0);
     ((void)0);
        ((void)0);
...
# 179 "../src/kf32a1x6_cmp.c"
    tmpreg = ((CMPInitStruct->m_PositiveInput ) |
      ...
      (CMPInitStruct->m_ScopecontrolEnable << (2)) |
      (CMPInitStruct->m_OutputPolarity));
    (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1), ~(((uint32_t)0x0F<<((28))) | ((uint32_t)0x0F<<((24))) | ((uint32_t)1<<((19))) | ((uint32_t)1<<((18))) | ((uint32_t)0x3<<((16))) | ((uint32_t)0xFF<<((8))) | ((uint32_t)0x7<<((4))) | ((uint32_t)1<<((3))) | ((uint32_t)1<<((2))) | ((uint32_t)1<<((1)))), tmpreg);

     if ((CMPInitStruct->m_CmpEnable) != FALSE)
     {

         __asm volatile("SET [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((1)));
     }
     else
     {

         __asm volatile("CLR [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((1)));
     }
    }
    else if(CMPx_ADDR==((uint32_t)0x40000808))
    {
     ((void)0);
     ((void)0);
        ((void)0);
...
# 226 "../src/kf32a1x6_cmp.c"
    tmpreg = ((CMPInitStruct->m_PositiveInput ) |
      ...
      (CMPInitStruct->m_ScopecontrolEnable << (2)) |
      (CMPInitStruct->m_OutputPolarity));
    (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2), ~(((uint32_t)0x0F<<((28))) | ((uint32_t)0x0F<<((24))) | ((uint32_t)1<<((19))) | ((uint32_t)1<<((18))) | ((uint32_t)0x3<<((16))) | ((uint32_t)0xFF<<((8))) | ((uint32_t)0x7<<((4))) | ((uint32_t)1<<((3))) | ((uint32_t)1<<((2))) | ((uint32_t)1<<((1)))), tmpreg);

     if ((CMPInitStruct->m_CmpEnable) != FALSE)
     {

         __asm volatile("SET [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((2)));
     }
     else
     {

         __asm volatile("CLR [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((2)));
     }
    }
    else if(CMPx_ADDR==((uint32_t)0x4000080C))
    {
        ((void)0);
  ((void)0);
        ((void)0);
...
# 273 "../src/kf32a1x6_cmp.c"
    ...
    (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3), ~(((uint32_t)0x0F<<((28))) | ((uint32_t)0x0F<<((24))) | ((uint32_t)0x3<<((16))) | ((uint32_t)0xFF<<((8))) | ((uint32_t)0x7<<((4))) | ((uint32_t)1<<((3))) | ((uint32_t)1<<((2))) | ((uint32_t)1<<((1))) | (0)), tmpreg);
    }
    else
    {
     ;
    }
    (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) |= (uint32_t)1 << 10;
}
...
void CMP_IO_Channel_Enable(FunctionalState NewState)
{
 ...
 (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) |= (uint32_t)NewState << (10);
}
# 359 "../src/kf32a1x6_cmp.c"
void CMP0_POSITIVE_INPUT_SELECT (uint32_t Select)
{

    ((void)0);

    (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0),
                               ~((uint32_t)0x0F<<((28))),
                               Select);
}
# 390 "../src/kf32a1x6_cmp.c"
void CMP0_NEGATIVE_INPUT_SELECT (uint32_t Select)
{
...
# 418 "../src/kf32a1x6_cmp.c"
void CMP1_POSITIVE_INPUT_SELECT (uint32_t Select)
{

    ((void)0);

    (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1),
                               ~((uint32_t)0x0F<<((28))),
                               Select);
}
# 446 "../src/kf32a1x6_cmp.c"
void CMP1_NEGATIVE_INPUT_SELECT (uint32_t Select)
{
...
# 473 "../src/kf32a1x6_cmp.c"
void CMP2_POSITIVE_INPUT_SELECT (uint32_t Select)
{

    ((void)0);

    (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2),
                               ~((uint32_t)0x0F<<((28))),
                               Select);
}
# 500 "../src/kf32a1x6_cmp.c"
void CMP2_NEGATIVE_INPUT_SELECT (uint32_t Select)
{
...
void CMP3_POSITIVE_INPUT_SELECT (uint32_t Select)
{
    ...
    (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3),
                               ~((uint32_t)0x0F<<((28))),
                               Select);
}
# 557 "../src/kf32a1x6_cmp.c"
void CMP3_NEGATIVE_INPUT_SELECT (uint32_t Select)
{
...
void CMP_OUTPUT_POL_SELECT(uint32_t CMPx_ADDR, uint32_t Polarity)
{
 ...
 switch (CMPx_ADDR)
 {
 case ((uint32_t)0x40000800):
     (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0), ~((uint32_t)1<<((1))), Polarity);
  break;
 case ((uint32_t)0x40000804):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1), ~((uint32_t)1<<((1))), Polarity);
  break;
 case ((uint32_t)0x40000808):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2), ~((uint32_t)1<<((1))), Polarity);
  break;
 case ((uint32_t)0x4000080C):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3), ~((uint32_t)1<<((1))), Polarity);
  break;
 default:break;
 }
}
# 607 "../src/kf32a1x6_cmp.c"
void CMP_OUTPUT_SELECT (uint32_t Select)
{

    ((void)0);

    (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4),
                               ~((uint32_t)0x03<<((20))),
                               Select);
}
...
void CMP_Cmd(uint32_t CMPx_ADDR, uint32_t NewState)
{
 ...
 {
 case ((uint32_t)0x40000800):
     (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4), ~((uint32_t)1<<((0))), NewState << (0));
  break;
 case ((uint32_t)0x40000804):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4), ~((uint32_t)1<<((1))), NewState << (1));
  break;
 case ((uint32_t)0x40000808):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4), ~((uint32_t)1<<((2))), NewState << (2));
  break;
 case ((uint32_t)0x4000080C):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3), ~((uint32_t)1<<((0))), NewState << (0));
  break;
 default:break;
 }
}
# 655 "../src/kf32a1x6_cmp.c"
void CMP_WIN_Control_CLK_Select(uint32_t CMPx_ADDR, uint32_t Select)
{
 ...
 {
 case ((uint32_t)0x40000800):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0), ~((uint32_t)1<<(7)), Select << (7));
  break;
 case ((uint32_t)0x40000804):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1), ~((uint32_t)1<<(7)), Select << (7));
  break;
 case ((uint32_t)0x40000808):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2), ~((uint32_t)1<<(7)), Select << (7));
  break;
 case ((uint32_t)0x4000080C):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3), ~((uint32_t)1<<(7)), Select << (7));
  break;
 default:break;
 }
}
# 688 "../src/kf32a1x6_cmp.c"
void CMP_Filter_CLKSource_Select(uint32_t CMPx_ADDR, uint32_t Select)
{
 ...
 {
 case ((uint32_t)0x40000800):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0), ~((uint32_t)0x3<<((16))), Select);
  break;
 case ((uint32_t)0x40000804):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1), ~((uint32_t)0x3<<((16))), Select);
  break;
 case ((uint32_t)0x40000808):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2), ~((uint32_t)0x3<<((16))), Select);
  break;
 case ((uint32_t)0x4000080C):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3), ~((uint32_t)0x3<<((16))), Select);
  break;
 default:break;
 }
}
# 726 "../src/kf32a1x6_cmp.c"
void CMP_Filter_SampleNumber_Select(uint32_t CMPx_ADDR, uint32_t Select)
{
 ...
 {
 case ((uint32_t)0x40000800):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0), ~((uint32_t)0x7<<((4))), Select);
  break;
 case ((uint32_t)0x40000804):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1), ~((uint32_t)0x7<<((4))), Select);
  break;
 case ((uint32_t)0x40000808):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2), ~((uint32_t)0x7<<((4))), Select);
  break;
 case ((uint32_t)0x4000080C):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3), ~((uint32_t)0x7<<((4))), Select);
  break;
 default:break;
 }
}
# 764 "../src/kf32a1x6_cmp.c"
void CMP_Up_Down_Edge_INT_Enable(uint32_t CMPx_ADDR, uint32_t UDEdge, uint32_t NewState)
{
 ...
 {
 case ((uint32_t)0x40000800):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL0), ~(1<<UDEdge), NewState<<UDEdge);
  break;
 case ((uint32_t)0x40000804):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL1), ~(1<<UDEdge), NewState<<UDEdge);
  break;
 case ((uint32_t)0x40000808):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL2), ~(1<<UDEdge), NewState<<UDEdge);
  break;
 case ((uint32_t)0x4000080C):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL3), ~(1<<UDEdge), NewState<<UDEdge);
  break;
 default:break;
 }
}
...
FlagStatus CMP_Get_Output_State(uint32_t CMPx_ADDR)
{
 ...
 {
 case ((uint32_t)0x40000800):
     return (((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) & ((uint32_t)1<<((28)))) >> (28));
  break;
 case ((uint32_t)0x40000804):
  return (((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) & ((uint32_t)1<<((29)))) >> (29));
  break;
 case ((uint32_t)0x40000808):
  return (((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) & ((uint32_t)1<<((30)))) >> (30));
  break;
 case ((uint32_t)0x4000080C):
  return (((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) & ((uint32_t)1<<((31)))) >> (31));
  break;
 default:break;
 }
}
...
FlagStatus CMP_Get_INT_Flag(uint32_t CMPx_ADDR)
{
 ...
 {
 case ((uint32_t)0x40000800):
     return (((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) & ((uint32_t)1<<((24)))) >> (24));
  break;
 case ((uint32_t)0x40000804):
  return (((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) & ((uint32_t)1<<((25)))) >> (25));
  break;
 case ((uint32_t)0x40000808):
  return (((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) & ((uint32_t)1<<((26)))) >> (26));
  break;
 case ((uint32_t)0x4000080C):
  return (((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) & ((uint32_t)1<<((27)))) >> (27));
  break;
 default:break;
 }
}
# 852 "../src/kf32a1x6_cmp.c"
void CMP_Trigger_Select_Config (uint32_t TriSelect)
{
    ...
    (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4), ~((uint32_t)1<<((23))), TriSelect);
}
...
RetStatus CMP_Clear_INT_Flag(uint32_t CMPx_ADDR)
{
 ...
 {
 case ((uint32_t)0x40000800):
     __asm volatile("SET [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((16)));
     while(((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) & ((uint32_t)1<<((24))))&& (wait_flag != (0xFFFF)))
  {
   wait_flag++;
  }
     __asm volatile("CLR [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((16)));
  break;
 case ((uint32_t)0x40000804):
     __asm volatile("SET [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((17)));
     while(((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) & ((uint32_t)1<<((25))))&& (wait_flag != (0xFFFF)))
  {
   wait_flag++;
  }
     __asm volatile("CLR [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((17)));
  break;
 case ((uint32_t)0x40000808):
     __asm volatile("SET [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((18)));
     while(((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) & ((uint32_t)1<<((26))))&& (wait_flag != (0xFFFF)))
  {
   wait_flag++;
  }
     __asm volatile("CLR [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((18)));
  break;
 case ((uint32_t)0x4000080C):
     __asm volatile("SET [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((19)));
     while(((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) & ((uint32_t)1<<((27))))&& (wait_flag != (0xFFFF)))
  {
   wait_flag++;
  }
     __asm volatile("CLR [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((19)));
  break;
 default:break;
 }
 if(wait_flag==(0xFFFF))
...
void CMP_INT_Enable(uint32_t CMPx_ADDR, uint32_t NewState)
{
 ...
 {
 case ((uint32_t)0x40000800):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4), ~((uint32_t)1<<((12))), NewState << (12));
  break;
 case ((uint32_t)0x40000804):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4), ~((uint32_t)1<<((13))), NewState << (13));
  break;
 case ((uint32_t)0x40000808):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4), ~((uint32_t)1<<((14))), NewState << (14));
  break;
 case ((uint32_t)0x4000080C):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4) = SFR_Config ((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4), ~((uint32_t)1<<((15))), NewState << (15));
  break;
 default:break;
 }
}
# 954 "../src/kf32a1x6_cmp.c"
void CMP_SluggishVoltage_Select (uint32_t Select)
{
    ((void)0);
...
void CMP_BEMF_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((4)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL4))),"i"((4)));
    }
}
# 1010 "../src/kf32a1x6_cmp.c"
void CMP_FLTINSEL_Select (uint32_t Select)
{
    ((void)0);
...
void CMP_Win_Control_TRGMUX_CH_Select (uint32_t CMPx_ADDR, uint32_t Select)
{
 ...
 {
 case ((uint32_t)0x40000800):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL5) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL5), ~((uint32_t)0x03<<((0))), Select << (0));
  break;
 case ((uint32_t)0x40000804):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL5) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL5), ~((uint32_t)0x03<<((2))), Select << (2));
  break;
 case ((uint32_t)0x40000808):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL5) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL5), ~((uint32_t)0x03<<((4))), Select << (4));
  break;
 case ((uint32_t)0x4000080C):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL5) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL5), ~((uint32_t)0x03<<((6))), Select << (6));
  break;
 default:break;
 }
}
# 1060 "../src/kf32a1x6_cmp.c"
void CMP_LP_Enable(FunctionalState NewState)
{

 ((void)0);

 (((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL5) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->CTL5), ~((uint32_t)1<<((8))), NewState << (8));
}
# 1075 "../src/kf32a1x6_cmp.c"
void CMP_TRIM_PMOS_Enable(FunctionalState NewState)
{

 ((void)0);

 (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM0) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM0), ~((uint32_t)1<<((30))), NewState << (30));
}
# 1090 "../src/kf32a1x6_cmp.c"
void CMP_TRIM_NMOS_Enable(FunctionalState NewState)
{

 ((void)0);

 (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM0) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM0), ~((uint32_t)1<<((31))), NewState << (31));
}
...
void CMP_TRIM_PMOS_Cail(uint32_t CMPx_ADDR, uint8_t Value)
{
 ...
 {
 case ((uint32_t)0x40000800):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM0) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM0), ~((uint32_t)0x3F<<((8))), Value << (8));
  break;
 case ((uint32_t)0x40000804):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM1) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM1), ~((uint32_t)0x3F<<((8))), Value << (8));
  break;
 case ((uint32_t)0x40000808):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM2) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM2), ~((uint32_t)0x3F<<((8))), Value << (8));
  break;
 case ((uint32_t)0x4000080C):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM3) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM3), ~((uint32_t)0x3F<<((8))), Value << (8));
  break;
 default:break;
 }
}
# 1136 "../src/kf32a1x6_cmp.c"
void CMP_TRIM_PMOS_Direction_Select(uint32_t CMPx_ADDR, uint32_t Direction)
{
 ...
 {
 case ((uint32_t)0x40000800):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM0) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM0), ~((uint32_t)1<<((7))), Direction << (7));
  break;
 case ((uint32_t)0x40000804):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM1) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM1), ~((uint32_t)1<<((7))), Direction << (7));
  break;
 case ((uint32_t)0x40000808):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM2) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM2), ~((uint32_t)1<<((7))), Direction << (7));
  break;
 case ((uint32_t)0x4000080C):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM3) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM3), ~((uint32_t)1<<((7))), Direction << (7));
  break;
 default:break;
 }
}
...
void CMP_TRIM_NMOS_Cail(uint32_t CMPx_ADDR, uint8_t Value)
{
 ...
 {
 case ((uint32_t)0x40000800):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM0) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM0), ~((uint32_t)0x3F<<((1))), Value << (1));
  break;
 case ((uint32_t)0x40000804):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM1) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM1), ~((uint32_t)0x3F<<((1))), Value << (1));
  break;
 case ((uint32_t)0x40000808):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM2) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM2), ~((uint32_t)0x3F<<((1))), Value << (1));
  break;
 case ((uint32_t)0x4000080C):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM3) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM3), ~((uint32_t)0x3F<<((1))), Value << (1));
  break;
 default:break;
 }
}
# 1198 "../src/kf32a1x6_cmp.c"
void CMP_TRIM_NMOS_Direction_Select(uint32_t CMPx_ADDR, uint32_t Direction)
{
 ...
 {
 case ((uint32_t)0x40000800):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM0) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM0), ~((uint32_t)1<<((0))), Direction << (0));
  break;
 case ((uint32_t)0x40000804):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM1) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM1), ~((uint32_t)1<<((0))), Direction << (0));
  break;
 case ((uint32_t)0x40000808):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM2) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM2), ~((uint32_t)1<<((0))), Direction << (0));
  break;
 case ((uint32_t)0x4000080C):
  (((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM3) = SFR_Config((((CMP_SFRmap *) ((uint32_t)0x40000800))->TRIM3), ~((uint32_t)1<<((0))), Direction << (0));
  break;
 default:break;
 }
}
