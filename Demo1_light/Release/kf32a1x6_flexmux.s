	.file	"kf32a1x6_flexmux.c"
	.stabs	"D:\\\\KungFu32\\\\workspace32\\\\Demo1_light\\\\Release/",100,0,2,.Ltext0
	.stabs	"../src/kf32a1x6_flexmux.c",100,0,2,.Ltext0
	.text
.Ltext0:
	...
	.stabs	"D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_flexmux.h",130,0,0,0
	...
	.text$FMUX_Reset$scode_loacal_1:
	.align	1
	.stabs	"FMUX_Reset:F(0,15)",36,0,40,FMUX_Reset
	.export	FMUX_Reset
	.type	FMUX_Reset, @function
FMUX_Reset:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext1
.Ltext1:
...
.Lscope1:
	...
	.text$FMUX_Channel_Enable$scode_loacal_2:
	.align	1
	.stabs	"FMUX_Channel_Enable:F(0,15)",36,0,56,FMUX_Channel_Enable
	.stabs	"Channel:P(4,6)",64,0,56,0
	.stabs	"NewState:P(3,2)",64,0,56,1
	.export	FMUX_Channel_Enable
	.type	FMUX_Channel_Enable, @function
FMUX_Channel_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext2
.Ltext2:
...
.Ltext3:
	.stabn	68,0,14083,.LM10-.LFBB2
.LM10:
	ANL	r4,r4,r3
.LBE17:
.LBE16:
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,65,.LM11-.LFBB2
.LM11:
	LSL	r1,r1,r0
.LBB19:
.LBB18:
...
.Ltext5:
	.stabn	68,0,14083,.LM12-.LFBB2
.LM12:
	ORL	r4,r4,r1
.LBE18:
.LBE19:
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext6
.Ltext6:
...
.Lscope2:
	...
	.text$FMUX_Channel_Triggle_Source_Select$scode_loacal_3:
	.align	1
	.stabs	"FMUX_Channel_Triggle_Source_Select:F(0,15)",36,0,186,FMUX_Channel_Triggle_Source_Select
	.stabs	"Channel:P(4,6)",64,0,186,0
	.stabs	"Source:P(4,6)",64,0,186,1
...
FMUX_Channel_Triggle_Source_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,187,.LM15-.LFBB3
.LM15:
.LFBB3:
	.stabn	68,0,195,.LM16-.LFBB3
.LM16:
	LSL	r0,#3
	.stabn	68,0,197,.LM17-.LFBB3
.LM17:
	LD	r5,#1073753344
	LD.w	r3,[r5]
	.stabn	68,0,196,.LM18-.LFBB3
.LM18:
	MOV	r4,#127
	LSL	r4,r4,r0
	.stabn	68,0,197,.LM19-.LFBB3
.LM19:
	NOT	r4,r4
.LBB20:
.LBB21:
...
.Ltext8:
	.stabn	68,0,14083,.LM20-.LFBB3
.LM20:
	ANL	r4,r4,r3
.LBE21:
.LBE20:
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,195,.LM21-.LFBB3
.LM21:
	LSL	r1,r1,r0
.LBB23:
.LBB22:
...
.Ltext10:
	.stabn	68,0,14083,.LM22-.LFBB3
.LM22:
	ORL	r4,r4,r1
.LBE22:
.LBE23:
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,197,.LM23-.LFBB3
.LM23:
	ST.w	[r5],r4
	.stabn	68,0,198,.LM24-.LFBB3
.LM24:
	JMP	lr
...
.Lscope3:
	...
	.text$FMUX_Enable$scode_loacal_4:
	.align	1
	.stabs	"FMUX_Enable:F(0,15)",36,0,207,FMUX_Enable
	.stabs	"NewState:P(3,2)",64,0,207,0
	.export	FMUX_Enable
	.type	FMUX_Enable, @function
FMUX_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext12
.Ltext12:
	.stabn	68,0,208,.LM25-.LFBB4
.LM25:
.LFBB4:
	.stabn	68,0,212,.LM26-.LFBB4
.LM26:
	LD	r5,#1073753344
	LD.w	r4,[r5+#1]
.LBB24:
.LBB25:
	.stabs	"D:\\KungFu32\\workspace32\\Demo1_light\\inc/KF32A156.h",132,0,0,.Ltext13
.Ltext13:
	.stabn	68,0,14083,.LM27-.LFBB4
.LM27:
	CLR	r4,#0
	ORL	r0,r0,r4
.LBE25:
.LBE24:
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext14
.Ltext14:
	.stabn	68,0,212,.LM28-.LFBB4
.LM28:
	ST.w	[r5+#1],r0
	.stabn	68,0,213,.LM29-.LFBB4
.LM29:
	JMP	lr
...
.Lscope4:
	...
	.text$FMUX_Output_Channel_DMA_Enable$scode_loacal_5:
	.align	1
	.stabs	"FMUX_Output_Channel_DMA_Enable:F(0,15)",36,0,224,FMUX_Output_Channel_DMA_Enable
	.stabs	"Channel:P(4,6)",64,0,224,0
	.stabs	"NewState:P(3,2)",64,0,224,1
	.export	FMUX_Output_Channel_DMA_Enable
	.type	FMUX_Output_Channel_DMA_Enable, @function
FMUX_Output_Channel_DMA_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext15
.Ltext15:
	.stabn	68,0,225,.LM30-.LFBB5
.LM30:
.LFBB5:
	.stabn	68,0,233,.LM31-.LFBB5
.LM31:
	ADD	r0,r0,#1
	.stabn	68,0,235,.LM32-.LFBB5
.LM32:
	LD	r5,#1073753344
	LD.w	r3,[r5+#1]
	.stabn	68,0,234,.LM33-.LFBB5
.LM33:
	MOV	r4,#1
	LSL	r4,r4,r0
	.stabn	68,0,235,.LM34-.LFBB5
.LM34:
	NOT	r4,r4
.LBB26:
.LBB27:
	.stabs	"D:\\KungFu32\\workspace32\\Demo1_light\\inc/KF32A156.h",132,0,0,.Ltext16
.Ltext16:
	.stabn	68,0,14083,.LM35-.LFBB5
.LM35:
	ANL	r4,r4,r3
.LBE27:
.LBE26:
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext17
.Ltext17:
	.stabn	68,0,233,.LM36-.LFBB5
.LM36:
	LSL	r1,r1,r0
.LBB29:
.LBB28:
...
.Ltext18:
	.stabn	68,0,14083,.LM37-.LFBB5
.LM37:
	ORL	r4,r4,r1
.LBE28:
.LBE29:
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext19
.Ltext19:
	.stabn	68,0,235,.LM38-.LFBB5
.LM38:
	ST.w	[r5+#1],r4
	.stabn	68,0,236,.LM39-.LFBB5
.LM39:
	JMP	lr
...
.Lscope5:
	...
	.text$FMUX_Triggle_Single_Maintain_Time_Select$scode_loacal_6:
	.align	1
	.stabs	"FMUX_Triggle_Single_Maintain_Time_Select:F(0,15)",36,0,249,FMUX_Triggle_Single_Maintain_Time_Select
	.stabs	"Channel:P(4,6)",64,0,249,0
	.stabs	"DIV:P(4,6)",64,0,249,1
...
FMUX_Triggle_Single_Maintain_Time_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext20
.Ltext20:
	.stabn	68,0,250,.LM40-.LFBB6
.LM40:
.LFBB6:
	.stabn	68,0,258,.LM41-.LFBB6
.LM41:
	ADD	r0,r0,r0
	ADD	r0,r0,#5
	.stabn	68,0,260,.LM42-.LFBB6
.LM42:
	LD	r5,#1073753344
	LD.w	r3,[r5+#1]
	.stabn	68,0,259,.LM43-.LFBB6
.LM43:
	MOV	r4,#3
	LSL	r4,r4,r0
	.stabn	68,0,260,.LM44-.LFBB6
.LM44:
	NOT	r4,r4
.LBB30:
.LBB31:
...
.Ltext21:
	.stabn	68,0,14083,.LM45-.LFBB6
.LM45:
	ANL	r4,r4,r3
.LBE31:
.LBE30:
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext22
.Ltext22:
	.stabn	68,0,258,.LM46-.LFBB6
.LM46:
	LSL	r1,r1,r0
.LBB33:
.LBB32:
...
.Ltext23:
	.stabn	68,0,14083,.LM47-.LFBB6
.LM47:
	ORL	r4,r4,r1
.LBE32:
.LBE33:
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext24
.Ltext24:
	.stabn	68,0,260,.LM48-.LFBB6
.LM48:
	ST.w	[r5+#1],r4
	.stabn	68,0,261,.LM49-.LFBB6
.LM49:
	JMP	lr
...
.Lscope6:
	...
	.text$FMUX_Output_Select$scode_loacal_7:
	.align	1
	.stabs	"FMUX_Output_Select:F(0,15)",36,0,274,FMUX_Output_Select
	.stabs	"Channel:P(4,6)",64,0,274,0
	.stabs	"MODE:P(4,6)",64,0,274,1
	.export	FMUX_Output_Select
	.type	FMUX_Output_Select, @function
FMUX_Output_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext25
.Ltext25:
	.stabn	68,0,275,.LM50-.LFBB7
.LM50:
.LFBB7:
	.stabn	68,0,283,.LM51-.LFBB7
.LM51:
	ADD	r0,r0,r0
	ADD	r0,#13
	.stabn	68,0,285,.LM52-.LFBB7
.LM52:
	LD	r5,#1073753344
	LD.w	r3,[r5+#1]
	.stabn	68,0,284,.LM53-.LFBB7
.LM53:
	MOV	r4,#3
	LSL	r4,r4,r0
	.stabn	68,0,285,.LM54-.LFBB7
.LM54:
	NOT	r4,r4
.LBB34:
.LBB35:
...
.Ltext26:
	.stabn	68,0,14083,.LM55-.LFBB7
.LM55:
	ANL	r4,r4,r3
.LBE35:
.LBE34:
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext27
.Ltext27:
	.stabn	68,0,283,.LM56-.LFBB7
.LM56:
	LSL	r1,r1,r0
.LBB37:
.LBB36:
...
.Ltext28:
	.stabn	68,0,14083,.LM57-.LFBB7
.LM57:
	ORL	r4,r4,r1
.LBE36:
.LBE37:
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext29
.Ltext29:
	.stabn	68,0,285,.LM58-.LFBB7
.LM58:
	ST.w	[r5+#1],r4
	.stabn	68,0,286,.LM59-.LFBB7
.LM59:
	JMP	lr
...
.Lscope7:
	...
	.text$FMUX_Work_CLK_Select$scode_loacal_8:
	.align	1
	.stabs	"FMUX_Work_CLK_Select:F(0,15)",36,0,294,FMUX_Work_CLK_Select
	.stabs	"CLK:P(4,6)",64,0,294,0
	.export	FMUX_Work_CLK_Select
	.type	FMUX_Work_CLK_Select, @function
FMUX_Work_CLK_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext30
.Ltext30:
	.stabn	68,0,295,.LM60-.LFBB8
.LM60:
.LFBB8:
	.stabn	68,0,299,.LM61-.LFBB8
.LM61:
	LD	r5,#1073753344
	LD.w	r4,[r5+#1]
	LSL	r0,#21
...
.LBE39:
.LBE38:
	.stabs	"../src/kf32a1x6_flexmux.c",132,0,0,.Ltext32
.Ltext32:
	.stabn	68,0,299,.LM63-.LFBB8
.LM63:
	ST.w	[r5+#1],r4
