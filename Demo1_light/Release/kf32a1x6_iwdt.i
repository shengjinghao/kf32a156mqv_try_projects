...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_iwdt.h" 2
...
# 33 "../src/kf32a1x6_iwdt.c" 2
# 61 "../src/kf32a1x6_iwdt.c"
void IWDT_Prescaler_Config (uint32_t Prescaler)
{
...
# 77 "../src/kf32a1x6_iwdt.c"
void IWDT_SCK_Source_Select(uint32_t Source)
{

 ((void)0);

 (((IWDT_SFRmap *) ((uint32_t)0x40001200))->CTL) = SFR_Config((((IWDT_SFRmap *) ((uint32_t)0x40001200))->CTL), ~((uint32_t)1<<((29))), Source << (29));
}
