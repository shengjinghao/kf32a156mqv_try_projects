...
# 31 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_aes.h" 2
...
# 34 "../src/kf32a1x6_aes.c" 2
# 43 "../src/kf32a1x6_aes.c"
void AES_Reset ()
{
...
# 58 "../src/kf32a1x6_aes.c"
void AES_Run_Enable(FunctionalState NewState)
{

 ((void)0);

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)1<<((31))), NewState << (31));
}
# 73 "../src/kf32a1x6_aes.c"
void AES_High_Speed_Enable(FunctionalState NewState)
{

 ((void)0);

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)1<<((30))), NewState << (30));
}
# 88 "../src/kf32a1x6_aes.c"
void AES_CBC_Mode_Select(uint32_t Mode)
{

 ((void)0);

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)1<<((20))), Mode << (20));
}
# 104 "../src/kf32a1x6_aes.c"
void AES_TRNG_SCK_Select(uint32_t Source)
{

 ((void)0);

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)0x03<<((16))), Source << (16));
}
# 125 "../src/kf32a1x6_aes.c"
void AES_SCK_DIV_Select(uint32_t CLKDIV)
{

 ((void)0);

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)0x07<<((13))), CLKDIV << (13));
}
...
void AES_RND_NUM_Config(uint32_t RNG_NUM)
{
 ...
 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)0x1F<<((8))), RNG_NUM << (8));
}
...
void AES_KEY_LEN_Config(uint32_t KEY_LEN)
{
 ...
 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)0x07<<((4))), KEY_LEN << (4));
}
# 167 "../src/kf32a1x6_aes.c"
void AES_SBOX_INV_Enable(uint32_t SBOXMODE)
{

 ((void)0);

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)1<<((3))), SBOXMODE << (3));
}
# 182 "../src/kf32a1x6_aes.c"
void AES_ENCRYPT_Function_Enable(uint32_t EN_DECRYPT)
{

 ((void)0);

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)1<<((2))), EN_DECRYPT << (2));
}
# 197 "../src/kf32a1x6_aes.c"
void AES_CUSTOMIZE_ALGORITHM_Enable(uint32_t ALGORITHM)
{

 ((void)0);

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)1<<((1))), ALGORITHM << (1));
}
# 212 "../src/kf32a1x6_aes.c"
void AES_Enable(FunctionalState NewState)
{

 ((void)0);

 (((AES_SFRmap *) ((uint32_t)0x40002700))->CTL) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->CTL), ~((uint32_t)1<<((0))), NewState);
}
# 227 "../src/kf32a1x6_aes.c"
FlagStatus AES_Get_INT_Flag(void)
{
 if((((AES_SFRmap *) ((uint32_t)0x40002700))->INT) & ((uint32_t)1<<((2))))
 {
  return SET;
 }
 else
...
void AES_Clear_INT_Flag(void)
{
 __asm volatile("SET [%0], #%1"::"r"(&((((AES_SFRmap *) ((uint32_t)0x40002700))->INT))),"i"((1)));
 while((((AES_SFRmap *) ((uint32_t)0x40002700))->INT) & ((uint32_t)1<<((2))));
 __asm volatile("CLR [%0], #%1"::"r"(&((((AES_SFRmap *) ((uint32_t)0x40002700))->INT))),"i"((1)));
}
# 258 "../src/kf32a1x6_aes.c"
void AES_INT_Enable(AbleStatus NewState)
{

 ((void)0);

 (((AES_SFRmap *) ((uint32_t)0x40002700))->INT) = SFR_Config((((AES_SFRmap *) ((uint32_t)0x40002700))->INT), ~((uint32_t)1<<((0))), NewState);
}
