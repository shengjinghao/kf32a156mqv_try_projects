...
.Ltext0:
	...
	.stabs	"D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_iwdt.h",130,0,0,0
	...
	.text$IWDT_Prescaler_Config$scode_loacal_1:
	.align	1
	.stabs	"IWDT_Prescaler_Config:F(0,15)",36,0,61,IWDT_Prescaler_Config
	.stabs	"Prescaler:P(4,6)",64,0,61,0
	.export	IWDT_Prescaler_Config
	.type	IWDT_Prescaler_Config, @function
IWDT_Prescaler_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_iwdt.c",132,0,0,.Ltext1
.Ltext1:
	.stabn	68,0,62,.LM0-.LFBB1
.LM0:
.LFBB1:
	.stabn	68,0,67,.LM1-.LFBB1
.LM1:
	LD	r5,#1073746432
	LD.w	r3,[r5]
.LBB8:
...
.LBE9:
.LBE8:
	.stabs	"../src/kf32a1x6_iwdt.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,67,.LM3-.LFBB1
.LM3:
	ST.w	[r5],r0
	.stabn	68,0,68,.LM4-.LFBB1
.LM4:
	JMP	lr
...
.Lscope1:
	...
	.text$IWDT_SCK_Source_Select$scode_loacal_2:
	.align	1
	.stabs	"IWDT_SCK_Source_Select:F(0,15)",36,0,77,IWDT_SCK_Source_Select
	.stabs	"Source:P(4,6)",64,0,77,0
	.export	IWDT_SCK_Source_Select
	.type	IWDT_SCK_Source_Select, @function
IWDT_SCK_Source_Select:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_iwdt.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,78,.LM5-.LFBB2
.LM5:
.LFBB2:
	.stabn	68,0,82,.LM6-.LFBB2
.LM6:
	LD	r5,#1073746432
	LD.w	r4,[r5]
	LSL	r0,#29
...
.LBE11:
.LBE10:
	.stabs	"../src/kf32a1x6_iwdt.c",132,0,0,.Ltext6
.Ltext6:
...
.Lscope2:
	...
	.text$IWDT_Overflow_Config$scode_loacal_3:
	.align	1
	.stabs	"IWDT_Overflow_Config:F(0,15)",36,0,90,IWDT_Overflow_Config
	.stabs	"Overflow:P(4,6)",64,0,90,0
	.export	IWDT_Overflow_Config
	.type	IWDT_Overflow_Config, @function
IWDT_Overflow_Config:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_iwdt.c",132,0,0,.Ltext7
.Ltext7:
	.stabn	68,0,91,.LM10-.LFBB3
.LM10:
.LFBB3:
...
.LBE13:
.LBE12:
	.stabs	"../src/kf32a1x6_iwdt.c",132,0,0,.Ltext9
.Ltext9:
	.stabn	68,0,99,.LM14-.LFBB3
.LM14:
	ST.w	[r5],r4
	.stabn	68,0,100,.LM15-.LFBB3
.LM15:
	JMP	lr
...
.Lscope3:
	...
	.text$IWDT_Enable$scode_loacal_4:
	.align	1
	.stabs	"IWDT_Enable:F(0,15)",36,0,107,IWDT_Enable
	.stabs	"NewState:P(3,2)",64,0,107,0
	.export	IWDT_Enable
	.type	IWDT_Enable, @function
IWDT_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_iwdt.c",132,0,0,.Ltext10
.Ltext10:
	.stabn	68,0,108,.LM16-.LFBB4
.LM16:
.LFBB4:
	.stabn	68,0,116,.LM17-.LFBB4
.LM17:
	LD	r5,#1073746432
	.stabn	68,0,113,.LM18-.LFBB4
.LM18:
	CMP	r0,#0
	JNZ	.L8
	.stabn	68,0,121,.LM19-.LFBB4
.LM19:
// inline asm begin
	// 121 "../src/kf32a1x6_iwdt.c" 1
	CLR [r5], #31
	.stabn	68,0,123,.LM20-.LFBB4
.LM20:
// inline asm end
	JMP	lr
.L8:
	.stabn	68,0,116,.LM21-.LFBB4
.LM21:
// inline asm begin
	// 116 "../src/kf32a1x6_iwdt.c" 1
	SET [r5], #31
	.stabn	68,0,123,.LM22-.LFBB4
.LM22:
// inline asm end
	JMP	lr
...
.Lscope4:
	...
	.text$IWDT_Feed_The_Dog$scode_loacal_5:
	.align	1
	.stabs	"IWDT_Feed_The_Dog:F(0,15)",36,0,130,IWDT_Feed_The_Dog
	.export	IWDT_Feed_The_Dog
	.type	IWDT_Feed_The_Dog, @function
IWDT_Feed_The_Dog:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_iwdt.c",132,0,0,.Ltext11
.Ltext11:
	.stabn	68,0,131,.LM23-.LFBB5
.LM23:
.LFBB5:
	.stabn	68,0,132,.LM24-.LFBB5
.LM24:
	LD	r4,#1437226410
	LD	r5,#1073746432
	ST.w	[r5+#1],r4
	.stabn	68,0,133,.LM25-.LFBB5
.LM25:
	JMP	lr
