...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_cfgl.h" 2
...
# 33 "../src/kf32a1x6_cfgl.c" 2
# 66 "../src/kf32a1x6_cfgl.c"
void CFGL_Reset (void)
{
...
RetStatus CFGL1_Clear_RISEINT_Flag (void)
{
 ...
 __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002980))->CTL0)),"i"((29)));
 while(((((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR & ((uint32_t)1<<((8))))>>(8))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
 __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002980))->CTL0)),"i"((29)));
...
RetStatus CFGL2_Clear_RISEINT_Flag (void)
{
 ...
 __asm volatile("CLR [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->CTL0)),"i"((29)));
 while(((((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR & ((uint32_t)1<<((9))))>>(9))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
 __asm volatile("SET [%0], #%1"::"r"(&(((CFGL_SFRmap *) ((uint32_t)0x40002988))->CTL0)),"i"((29)));
...
void CFGL_Clear_INT_Flag(void)
{
 ((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR = SFR_Config(((CFGL_SFRmap *) ((uint32_t)0x40002988))->IFR, ~((uint32_t)1<<((2))), 0<<(2));
}
