...
.Ltext0:
	...
	.stabs	"D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_pclk.h",130,0,0,0
	...
	.text$PCLK_CTL0_Peripheral_Clock_Enable$scode_loacal_1:
	.align	1
	.stabs	"PCLK_CTL0_Peripheral_Clock_Enable:F(0,15)",36,0,54,PCLK_CTL0_Peripheral_Clock_Enable
	.stabs	"PCLK_CTL0_bit:P(4,6)",64,0,54,0
	.stabs	"NewState:P(3,2)",64,0,54,1
	.export	PCLK_CTL0_Peripheral_Clock_Enable
	.type	PCLK_CTL0_Peripheral_Clock_Enable, @function
PCLK_CTL0_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_pclk.c",132,0,0,.Ltext1
.Ltext1:
	.stabn	68,0,55,.LM0-.LFBB1
.LM0:
.LFBB1:
...
.LM1:
	LD	r5,#1073751616
	LD.w	r4,[r5]
	.stabn	68,0,60,.LM2-.LFBB1
.LM2:
	CMP	r1,#0
	JNZ	.L5
	.stabn	68,0,66,.LM3-.LFBB1
.LM3:
	NOT	r0,r0
	ANL	r0,r0,r4
	ST.w	[r5],r0
...
.LM4:
	JMP	lr
.L5:
	.stabn	68,0,62,.LM5-.LFBB1
.LM5:
	ORL	r0,r0,r4
	ST.w	[r5],r0
	.stabn	68,0,68,.LM6-.LFBB1
.LM6:
	JMP	lr
...
.Lscope1:
	...
	.text$PCLK_CTL1_Peripheral_Clock_Enable$scode_loacal_2:
	.align	1
	.stabs	"PCLK_CTL1_Peripheral_Clock_Enable:F(0,15)",36,0,99,PCLK_CTL1_Peripheral_Clock_Enable
	.stabs	"PCLK_CTL1_bit:P(4,6)",64,0,99,0
	.stabs	"NewState:P(3,2)",64,0,99,1
	.export	PCLK_CTL1_Peripheral_Clock_Enable
	.type	PCLK_CTL1_Peripheral_Clock_Enable, @function
PCLK_CTL1_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_pclk.c",132,0,0,.Ltext2
.Ltext2:
	.stabn	68,0,100,.LM7-.LFBB2
.LM7:
.LFBB2:
	.stabn	68,0,107,.LM8-.LFBB2
.LM8:
	LD	r5,#1073751616
	LD.w	r4,[r5+#1]
...
.LM11:
	JMP	lr
.L9:
	.stabn	68,0,107,.LM12-.LFBB2
.LM12:
	ORL	r0,r0,r4
	ST.w	[r5+#1],r0
	.stabn	68,0,113,.LM13-.LFBB2
.LM13:
	JMP	lr
...
.Lscope2:
	...
	.text$PCLK_CTL2_Peripheral_Clock_Enable$scode_loacal_3:
	.align	1
	.stabs	"PCLK_CTL2_Peripheral_Clock_Enable:F(0,15)",36,0,138,PCLK_CTL2_Peripheral_Clock_Enable
	.stabs	"PCLK_CTL2_bit:P(4,6)",64,0,138,0
	.stabs	"NewState:P(3,2)",64,0,138,1
	.export	PCLK_CTL2_Peripheral_Clock_Enable
	.type	PCLK_CTL2_Peripheral_Clock_Enable, @function
PCLK_CTL2_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_pclk.c",132,0,0,.Ltext3
.Ltext3:
	.stabn	68,0,139,.LM14-.LFBB3
.LM14:
.LFBB3:
	.stabn	68,0,146,.LM15-.LFBB3
.LM15:
	LD	r5,#1073751616
	LD.w	r4,[r5+#2]
	.stabn	68,0,144,.LM16-.LFBB3
.LM16:
	CMP	r1,#0
	JNZ	.L13
	.stabn	68,0,150,.LM17-.LFBB3
.LM17:
	NOT	r0,r0
	ANL	r0,r0,r4
	ST.w	[r5+#2],r0
	.stabn	68,0,152,.LM18-.LFBB3
.LM18:
	JMP	lr
.L13:
	.stabn	68,0,146,.LM19-.LFBB3
.LM19:
	ORL	r0,r0,r4
	ST.w	[r5+#2],r0
	.stabn	68,0,152,.LM20-.LFBB3
.LM20:
	JMP	lr
...
.Lscope3:
	...
	.text$PCLK_CTL3_Peripheral_Clock_Enable$scode_loacal_4:
	.align	1
	.stabs	"PCLK_CTL3_Peripheral_Clock_Enable:F(0,15)",36,0,185,PCLK_CTL3_Peripheral_Clock_Enable
	.stabs	"PCLK_CTL3_bit:P(4,6)",64,0,185,0
	.stabs	"NewState:P(3,2)",64,0,185,1
	.export	PCLK_CTL3_Peripheral_Clock_Enable
	.type	PCLK_CTL3_Peripheral_Clock_Enable, @function
PCLK_CTL3_Peripheral_Clock_Enable:
	.stabd	46,0,0
	.stabs	"../src/kf32a1x6_pclk.c",132,0,0,.Ltext4
.Ltext4:
	.stabn	68,0,186,.LM21-.LFBB4
.LM21:
.LFBB4:
	.stabn	68,0,193,.LM22-.LFBB4
.LM22:
	LD	r5,#1073751616
	LD.w	r4,[r5+#3]
	.stabn	68,0,191,.LM23-.LFBB4
.LM23:
	CMP	r1,#0
	JNZ	.L17
	.stabn	68,0,197,.LM24-.LFBB4
.LM24:
	NOT	r0,r0
	ANL	r0,r0,r4
	ST.w	[r5+#3],r0
	.stabn	68,0,199,.LM25-.LFBB4
.LM25:
	JMP	lr
.L17:
	.stabn	68,0,193,.LM26-.LFBB4
.LM26:
	ORL	r0,r0,r4
	ST.w	[r5+#3],r0
	.stabn	68,0,199,.LM27-.LFBB4
.LM27:
	JMP	lr
