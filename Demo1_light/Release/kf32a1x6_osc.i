...
# 29 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_osc.h" 2
...
# 36 "../src/kf32a1x6_osc.c" 2
# 46 "../src/kf32a1x6_osc.c"
void OSC_SCLK_Configuration (OSC_InitTypeDef* oscInitStruct)
{
 uint32_t tmpreg=0;
 uint32_t tmpmask=0;
    ...
    case ((uint32_t)0x2):
     ...
     (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2) = SFR_Config((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2), ~((uint32_t)0x0F<<((20))), (oscInitStruct->m_StartDelay) << (20));
     break;
    case ((uint32_t)0x3):

     (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2) = SFR_Config((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2), ~((uint32_t)0x0F<<((16))), (oscInitStruct->m_StartDelay) << (16));
     break;
    case ((uint32_t)0x4):

     tmpreg |= (oscInitStruct->m_PLLInputSource)<< (12);
     tmpmask |= ((uint32_t)1<<((12)));

     (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2) = SFR_Config((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2), ~((uint32_t)0x0F<<((20))), (oscInitStruct->m_StartDelay));
     break;
    default:break;
    }
 ...
 tmpreg |= (oscInitStruct->m_InputSource) << (1)
    ...
    (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL0) = SFR_Config ((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL0), ~(((uint32_t)7<<((1))) | ((uint32_t)7<<((16))) | tmpmask), tmpreg);
}
...
void OSC_HFCK_Configuration (OSC_InitTypeDef* oscInitStruct)
{
 ...
 tmpreg |= (oscInitStruct->m_InputSource) << (9)
    ...
    (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL0) = SFR_Config ((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL0), ~(((uint32_t)7<<((9))) | ((uint32_t)0xF<<((20))) | tmpmask), tmpreg);
}
...
void OSC_LFCK_Configuration (OSC_InitTypeDef* oscInitStruct)
{
    ...
    if (oscInitStruct->m_InputSource == ((uint32_t)0x1))
    {
        ...
        (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2) = SFR_Config ((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2), ~((uint32_t)0x0F<<((16))), tmpreg);
    }
    else
    {
        ;
...
void OSC_Struct_Init (OSC_InitTypeDef* oscInitStruct)
{
    ...
    oscInitStruct->m_StartDelay = ((uint32_t)0x00);
}
# 188 "../src/kf32a1x6_osc.c"
void OSC_LFCK_Division_Config (uint32_t LFDivision)
{
    uint32_t tmpreg;
...
void OSC_SCLK_Output_Select (uint32_t SclkSource)
{
    ...
    (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL1) = SFR_Config ((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL1), ~((uint32_t)0x07<<((25))), tmpreg);
}
# 477 "../src/kf32a1x6_osc.c"
void OSC_SCLK_Output_Division_Config (uint32_t OutputDivision)
{
    uint32_t tmpreg;
...
void OSC_Clock_Failure_Check_Division_Config (uint32_t FSCM_DIV)
{
 uint32_t tmpreg;
    ...
    tmpreg = FSCM_DIV << (17);
    (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL1) = SFR_Config((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL1), ~(((uint32_t)0x07<<((17)))), tmpreg);
}
# 547 "../src/kf32a1x6_osc.c"
void OSC_Clock_Failure_Check_Source_Config (uint32_t FSCM_Source)
{
 uint32_t tmpreg;
    ...
    tmpreg = FSCM_Source << (21);
    (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL1) = SFR_Config((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL1), ~(((uint32_t)0x07<<((21)))), tmpreg);
}
# 569 "../src/kf32a1x6_osc.c"
void OSC_PLL_Multiple_Value_Select (uint32_t PLLmultiple_M,uint32_t PLLmultiple_N,uint32_t PLLmultiple_NO)
{
    uint32_t tmpreg;
    ...
    (((PLL_SFRmap *)((uint32_t)0x40002580))->CTL) = SFR_Config ((((PLL_SFRmap *)((uint32_t)0x40002580))->CTL), ~(((uint32_t)0x3FFF<<((2))) | ((uint32_t)0xF<<((16))) | ((uint32_t)0x3<<((20)))), tmpreg);
}
...
void OSC_PLL_Start_Delay_Config (uint32_t PLLDelay)
{
    ...
    tmpreg = PLLDelay << (24);
    (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2) = SFR_Config ((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2), ~((uint32_t)0x0F<<((24))), tmpreg);
}
# 644 "../src/kf32a1x6_osc.c"
void OSC_EXTHF_Start_Delay_Config (uint32_t ExternalDelay)
{
    uint32_t tmpreg;
    ...
    (((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2) = SFR_Config ((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2), ~((uint32_t)0x0F<<((20))), tmpreg);
}
# 671 "../src/kf32a1x6_osc.c"
void OSC_EXTLF_Start_Delay_Config (uint32_t ExternalDelay)
{
    uint32_t tmpreg;
...
void OSC_LP4M_Software_Enable (FunctionalState NewState)
{
    ...
    if (NewState != FALSE)
    {
        ...
        __asm volatile("SET [%0], #%1"::"r"(&((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2))),"i"((6)));
    }
    else
    {

        __asm volatile("CLR [%0], #%1"::"r"(&((((OSC_SFRmap *)((uint32_t)0x40000000))->CTL2))),"i"((6)));
    }
}
