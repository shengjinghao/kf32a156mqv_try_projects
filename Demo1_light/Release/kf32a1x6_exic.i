...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_exic.h" 2
...
# 32 "../src/kf32a1x6_exic.c" 2
# 58 "../src/kf32a1x6_exic.c"
void EXIC_Reset (void)
{
...
RetStatus EXIC_Clear_Write_Finish_INT_Flag (void)
{
 ...
 while((((((EXIC_SFRmap *) ((uint32_t)0x40002800))->STATE) & ((uint32_t)1<<((0))))>>(0))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
...
RetStatus EXIC_Clear_Read_Finish_INT_Flag (void)
{
 ...
 while((((((EXIC_SFRmap *) ((uint32_t)0x40002800))->STATE) & ((uint32_t)1<<((1))))>>(1))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
