...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_qei.h" 2
...
# 40 "../src/kf32a1x6_qei.c" 2
# 69 "../src/kf32a1x6_qei.c"
void QEI_Reset (QEI_SFRmap* QEIx)
{
    ...
    else if(QEIx == ((QEI_SFRmap *) ((uint32_t)0x40000080)))
    {
...
void QEI_Timer_Configuration(QEI_SFRmap* QEIx, QEI_TimerTypeDef* qeiTimerInitStruct)
{
    uint32_t tmpreg;
...
# 414 "../src/kf32a1x6_qei.c"
void QEI_LP_Source_Clock_Config(QEI_SFRmap* QEIx, uint32_t QEICLK)
{
 uint32_t tmpreg;
    ...
    tmpreg = QEICLK << (11);
    QEIx->CTL0 = SFR_Config(QEIx->CTL0, ~((uint32_t)1<<((11))), tmpreg);
}
# 436 "../src/kf32a1x6_qei.c"
void QEI_Source_Clock_Config (QEI_SFRmap* QEIx, uint32_t PeripheralClock)
{
...
# 488 "../src/kf32a1x6_qei.c"
void QEI_Digital_Filter_Clock_Config (QEI_SFRmap* QEIx, uint32_t DigitalFilterClock)
{
...
RetStatus QEI_Clear_INT_Flag (QEI_SFRmap* QEIx, uint32_t InterruptType)
{
 ...
 uint32_t wait_flag=0x0000;
    ...
    QEIx->DIER |= tmpreg;
    while((QEIx->CTL0 & tmpreg1)&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
    QEIx->DIER &= ~tmpreg;
...
RetStatus QEI_Clear_Timer_Overflow_INT_Flag (QEI_SFRmap* QEIx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((QEIx->CTL0 & ((uint32_t)1<<((10))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus QEI_Clear_Phase_Error_INT_Flag (QEI_SFRmap* QEIx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((QEIx->CTL0 & ((uint32_t)1<<((9))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
...
RetStatus QEI_Clear_Counter_Error_INT_Flag (QEI_SFRmap* QEIx)
{
 uint32_t wait_flag=0x0000;
    ...
    while((QEIx->CTL0 & ((uint32_t)1<<((8))))&& (wait_flag != (0xFFFF)))
 {
  wait_flag++;
 }
