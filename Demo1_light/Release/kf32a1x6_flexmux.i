# 1 "../src/kf32a1x6_flexmux.c"
# 1 "D:\\KungFu32\\workspace32\\Demo1_light\\Release//"
# 1 "<command-line>"
# 1 "../src/kf32a1x6_flexmux.c"
# 30 "../src/kf32a1x6_flexmux.c"
# 1 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_flexmux.h" 1
# 29 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_flexmux.h"
...
# 30 "D:\\KungFu32\\workspace32\\Demo1_light\\inc/kf32a1x6_flexmux.h" 2
...
void FMUX_Reset(void)
{
 RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((21))), TRUE);
 RST_CTL3_Peripheral_Reset_Enable(((uint32_t)1<<((21))), FALSE);
 PCLK_CTL3_Peripheral_Clock_Enable(((uint32_t)1<<((21))), TRUE);
}
# 56 "../src/kf32a1x6_flexmux.c"
void FMUX_Channel_Enable(uint32_t Channel, FunctionalState NewState)
{
 uint32_t tmpreg;
 uint32_t tmask;
 ...
 tmpreg = NewState << ((7) + Channel*8);
 tmask = 1 << ((7) + Channel*8);
 (((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->SOU) = SFR_Config((((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->SOU), ~tmask, tmpreg);
}
# 186 "../src/kf32a1x6_flexmux.c"
void FMUX_Channel_Triggle_Source_Select(uint32_t Channel, uint32_t Source)
{
 uint32_t tmpreg;
 uint32_t tmask;
 ...
 tmask = ((uint32_t)0x7F<<((0))) << Channel*8;
 (((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->SOU) = SFR_Config((((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->SOU), ~tmask, tmpreg);
}
# 207 "../src/kf32a1x6_flexmux.c"
void FMUX_Enable(FunctionalState NewState)
{

 ((void)0);

 (((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->TAR) = SFR_Config((((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->TAR), ~((uint32_t)1<<((0))), NewState);
}
# 224 "../src/kf32a1x6_flexmux.c"
void FMUX_Output_Channel_DMA_Enable(uint32_t Channel, FunctionalState NewState)
{
 uint32_t tmpreg;
 uint32_t tmask;
 ...
 tmask = 1 << (Channel + 1);
 (((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->TAR) = SFR_Config((((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->TAR), ~tmask, tmpreg);
}
# 249 "../src/kf32a1x6_flexmux.c"
void FMUX_Triggle_Single_Maintain_Time_Select(uint32_t Channel, uint32_t DIV)
{
 uint32_t tmpreg;
 uint32_t tmask;
 ...
 tmpreg = DIV << ((5) + Channel*2);
 tmask = 0x03 << ((5) + Channel*2);
 (((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->TAR) = SFR_Config((((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->TAR), ~tmask, tmpreg);
}
# 274 "../src/kf32a1x6_flexmux.c"
void FMUX_Output_Select(uint32_t Channel, uint32_t MODE)
{
 uint32_t tmpreg;
 uint32_t tmask;
 ...
 tmpreg = MODE << ((13) + Channel*2);
 tmask = 0x03 << ((13) + Channel*2);
 (((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->TAR) = SFR_Config((((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->TAR), ~tmask, tmpreg);
}
...
void FMUX_Work_CLK_Select(uint32_t CLK)
{
 ...
 (((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->TAR) = SFR_Config((((FlexMUX_SFRmap*) ((uint32_t) 0x40002D00))->TAR), ~((uint32_t)0x03<<((21))), CLK << (21));
}
