...
void BoardGpioInit(void)
{
 ...
 GPIO_InitStructure.m_Pin = ((uint16_t)0x1000);
 GPIO_Configuration(((GPIO_SFRmap *) ((uint32_t)0x500000C0)) , &GPIO_InitStructure);


 GPIO_Set_Output_Data_Bits(((GPIO_SFRmap *) ((uint32_t)0x500000C0)), ((uint16_t)0x1000), Bit_SET);
# 48 "../main.c"
}
...
void BoardUserKeyInit(void)
{
 ...
 EINT_InitStructure.m_Line = ((uint32_t)0);
 EINT_InitStructure.m_Mask = TRUE;
 EINT_InitStructure.m_Rise = TRUE;
 EINT_InitStructure.m_Source = ((uint32_t)2);
...
int main()
{
 ...
 INT_Priority_Group_Config(((uint32_t)0<<((1))));
 ...
 while(1)
 {
  ...
  {
   TimingDelay = 0;
   GPIO_Toggle_Output_Data_Config(((GPIO_SFRmap *) ((uint32_t)0x500000C0)), ((uint16_t)0x1000));
  }
  systick_delay_ms(50);
